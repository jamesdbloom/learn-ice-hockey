...
>
> **Related:** [Center](positions/center.md) · [Defender](positions/defender.md) · [Winger](positions/winger.md) · [Breakouts](breakouts.md) · [Defending the Rush](defending_the_rush.md) · [Forechecking Systems](forechecking_systems.md) · [Neutral Zone Systems](neutral_zone_systems.md) · [On-Ice Communication](on_ice_communication.md)
...
Action: Box out at the net front — inside shoulder ahead of theirs, and lift the stick rather than cross-check the back
Rule: A goal can be disallowed where an attacker "by his positioning or by contact" impairs the goalie (NHL Rule 69.1), but that is a judgement after the fact — move the screen yourself
...
Get your inside shoulder ahead of theirs, establish position between them and the puck, and lift their stick rather than cross-checking their back. Full technique in [Defender](positions/defender.md) and [Body Contact and Battles](body_contact_and_battles.md). Two rules-relevant notes:
- **Screening your own goalie is your problem, not the referee's.** An attacker standing outside the crease in your goalie's sightline without touching them is, in the ordinary case, doing something legal. The one lever you have is Rule 69.1, which disallows a goal where an attacker *"either by his positioning or by contact, impairs the goalkeeper's ability to move freely within his crease or defend his goal"* — positioning alone can be enough. But that is a referee's judgement after the fact, not a whistle. Nobody is going to remove him for you — you have to move him.
...
"I've got the corner." "You have the net." "Switch." "Back door." Coverage is a shared model of who has whom; the only way to keep the model shared is out loud. See [On-Ice Communication](on_ice_communication.md).
...
- **It is exhausting.** You are skating a full shift — 30 to 80 seconds on the measured range, nearer 30–45 when it is well managed; [Conditioning and Recovery](conditioning_and_recovery.md) owns both figures — at your opponent's chosen pace, in your own zone.
...
**What it is:** the puck goes down to the corner or behind the net, drags your coverage low, and then gets passed back *up* to the point for a shot with your defenders' backs turned and traffic in front. Coaching material routinely calls it one of the most common ways modern teams score, and it exists precisely to punish low zone collapse. *(Shot-**location** data is public and plentiful — [Shooting](shooting.md) owns what it says. What does not exist publicly is a classification of goals by the **play that produced them**, which is what a ranking like this would need, so treat "one of the most common" as coaching consensus rather than a measured figure.)*
...
Action: Move the screen, don't watch it — get your body between them and your goalie's sightline, or walk them out with leverage under the arms
Technique: Lift the stick — a screen with a free stick is a deflection waiting to happen, and this is the highest-value thing a net-front defender does
...
**Defending it:**
- **Move the screen, don't watch it.** Screening from outside the crease, without contact, is normally legal — the referee will not help you in real time. Get your body between the screen and your goalie's sightline, or physically walk them out with leverage under the arms.
- **Lift the stick.** A screen with a free stick is a deflection waiting to happen; a screen with a lifted stick is just a person. This is the highest-value thing a net-front defender does.
...
- **Block from close if you block at all.** Ten feet from the shooter, square, shin pads to the puck, stick down beside you. See [Body Contact and Battles](body_contact_and_battles.md).
...
- **Whack it out — but do not cover it.** Under NHL Rule 67.4, a defending player other than the goalie who falls on, holds, picks up or gathers the puck into their body **inside the goal crease** gives up a **penalty shot**. Outside the crease, deliberately falling on it is a minor penalty. Your stick is legal; your glove and your chest are not.
...
- **Stay on your feet as long as possible.** A defender on the ice is a defender out of the play for two seconds, which is the whole scramble.
...
**Decide before you touch it.** The single biggest cause of turnovers on a zone exit is a defenceman receiving the puck and *then* starting to look. Scan while the battle is still going — see [Scanning and Anticipation](scanning_and_anticipation.md) — so that when the puck is yours you already know whether it's the winger, the centre, or the glass.
...
- **Both defencemen drawn to the same puck.** The goalmouth is empty and one pass beats five players.
...
- **Cross-checking the net-front player repeatedly** instead of lifting their stick. It is among the most predictable penalties in hockey — officials are told to watch for it at the net front — and a stick lift works better.
...
- **Covering a loose puck with your hand in your own crease** — that's a penalty shot, not a whistle.
