...
The evidence from attack type points the same way. Analysis of shot quality by attack type has found that **cycle attacks produce better shot quality for trailing teams, while rush attacks produce better results for leading teams** — and the pattern reverses when the game states reverse. In other words, when you are ahead your best offence is the counter-attack off a turnover, which requires you to be organised and *fast*, not passive.
...
**2. Chip out, don't force out.** A **chip** — a short, deliberate flip or wall-play that puts the puck past a forechecker and out of the zone — beats an attempted breakout pass under pressure. You will lose possession, but you'll lose it 150 feet from your net, with your team facing the right way. Getting the puck out and getting a change is worth more than a 40% chance at a controlled exit.
...
- **Sticks in lanes, feet in the house.** Most 6-on-5 goals come from tips, screens and rebounds. Clear bodies and take away sticks at the net front; the shot from the point is the least of your worries.
...
Shifts in fast, high-level hockey are typically **under a minute**, and the reason is simple physiology: hockey is repeated maximal effort, and the effort quality falls off a cliff well before you feel exhausted. A reasonable target for most players is **35–45 seconds**, shortened to **30–35 seconds** when protecting a lead or when the play is stuck in your own end. See [Conditioning and Recovery](conditioning_and_recovery.md).
...
2. **Feet** — you stop skating and start reaching, which is how sticks end up around waists and hands. Most late-shift penalties are fatigue penalties.
...
The practical consequence: **a 90-second shift is not three times as valuable as a 30-second shift. It is worth less in total, and it costs your next shift too.**
...
The most dangerous stretch in hockey is the sixty seconds after a goal against, because the conceding team is either deflated or over-eager, and both produce mistakes.
...
*Defence pairs and handedness: [Shot Location Data and Strategy I: Off-Hand Defencemen — puck++](https://puckplusplus.com/2014/11/11/shot-location-data-and-strategy-i-off-hand-defencemen/) · [Do defensemen play worse on their off-hand? — puck++](https://puckplusplus.com/2013/09/21/do-defensemen-play-worse-on-their-off-hand/) · [The Impact of Handedness on Defensemen — All Mighty Hockey Talk](https://allmightyhockeytalk.com/2024/07/24/the-impact-of-handedness-on-defensemen/)*
