...
Rule: A skater — "a defending player, except a goalkeeper" — covering a puck that is itself in your crease is a penalty shot (NHL Rule 67.4), or an awarded goal with your net empty (67.5); the puck's location decides, not yours (63.6)
...
**3. Covering the puck in your own crease costs you a penalty shot — or, again, a goal.** If a skater other than the goalkeeper *"falls on the puck, holds the puck, picks up the puck, or gathers the puck into his body or hands from the ice in the goal crease area"*, play stops immediately and the other team gets a penalty shot (**Rule 67.4**). **It is the puck that has to be in the crease, not you** — Rule 63.6: *"If the puck is outside the crease and gathered into the body of a player (other than the goalkeeper) who is inside the crease, minor penalty."* So the trade below is only on the table when the puck itself is in the blue paint. Against a puck that was going in anyway, that is a trade worth making. But if your goalie has already been replaced by an extra attacker, **Rule 67.5** awards the goal outright — you have prevented nothing at all.
