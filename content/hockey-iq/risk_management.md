...
```facts
Rule: All four books let you catch a puck out of the air, provided you immediately knock it down or place it on the ice — NHL and IIHF 67.2, USA Hockey 618(a), Hockey Canada 10.2(a)(iii), which adds "without gaining or attempting to gain an advantage". Do that and there is nothing to trade
...
Rule: A skater — "a defending player, except a goalkeeper" — covering a puck that is itself in your crease is a penalty shot (NHL 67.4); all four books make the puck's location the test (NHL and IIHF 63.6, USA Hockey 614(b) and 618(a), Hockey Canada 10.2(a)(iv)-(v))
...
Rule: With your net empty the same act is an awarded goal — NHL and IIHF 67.5 and Hockey Canada 10.2(a)(vi) on the bare fact of the substitution; USA Hockey alone conditions it, 614(b) and 618(a) awarding it only where the act "has prevented an obvious and imminent goal"
...
5. **Understand the "never" list, do not memorise it — and know which kind each one is. Seven of the nine are coaching conventions, not laws:** no D-to-D through your own slot; no blind backhand up the middle; no cross-ice pass in your own end; never both defencemen to one puck — **though aggressive systems do send both below the goal line on a specific read, so what actually survives is that somebody must be home, not that it is always the same somebody; find out what your team plays**; never force it at their blue line with nobody back; never stickhandle in your own slot; never change with the puck in your own zone. **The other two are named in a rulebook.** Putting the puck over the glass from your own end is a minor under NHL Rule 63.2, and only when it goes out *directly*, since a deflected one is not penalised. Leaving your feet to hit is written into the charging offence by name in all four rulebooks (NHL 42.1, IIHF 42.1, USA Hockey 607, Hockey Canada 7.4) — and Hockey Canada's interpretation of its own rule puts the offence at the takeoff, not the follow-through, since skates coming off *after* contact in an otherwise legal check is not charging under that book.
