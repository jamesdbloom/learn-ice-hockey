...
Rule: The after-the-whistle words are in three of those four — NHL and IIHF 63.2(ii) and USA Hockey 610(c); Hockey Canada 10.1(ii) omits them, though Rule 10.1's preamble reaches a player who delays the restart of play
...
Rule: Over the glass behind the players' bench is penalised; directly off a faceoff no penalty is assessed (NHL 63.2(iii) NOTE); only a puck shot straight in where there is no glass escapes — one that clears the glass and lands in the bench is still a minor (IIHF Handbook 63.24)
Rule: Do not rely on the skate under the IIHF — its Rulebook 63.2(III) names only "hand or stick" in 2025/26 and 2026/27 alike, but 63.2(II) reaches a deliberate one by foot from anywhere; its Handbook answers Yes to a kick over the glass (Situation 63.34, all three editions), so clear with the stick
Rule: USA Hockey 610(c) penalises only a deliberate shoot-out and 631(d) makes an accidental one a last-play faceoff; Hockey Canada 10.1(ii) is deliberate-only for skaters, and 10.1(v) writes no deliberateness word into the goaltender's limb
...
**All four books reach the deliberate clear, and none of them limits it by zone.** **USA Hockey 610(c)** assesses the minor on any player or goalkeeper who *"delays the game by deliberately shooting or batting the puck outside the playing area, including after a stoppage of play"*, and **Hockey Canada 10.1(ii)** on *"a player who deliberately shoots, bats, or throws the puck outside the playing surface."* ⚠️ **But the after-the-whistle words are in three of the four, not all four.** The NHL's and the IIHF's 63.2(ii) carry them, and so does USA Hockey's 610(c); **Hockey Canada 10.1(ii) does not print them.** Do not read that as a free shot after the whistle in Canada. Rule 10.1's preamble reaches the ground another way and is expressly open-ended — *"Delay of Game occurs when any player or team deliberately causes a stoppage of play or delays the restart of play. This includes, but is not limited to, the following actions"* — and 10.1(a) assesses a minor on any player *"who, in the opinion of the Referee, is deliberately delaying the game."* The route is different; assume the two minutes are still there.

**Neither North American book has the NHL's strict-liability version.** **Hockey Canada** splits it by who you are: Rule 10.1(ii) reaches only a skater who *"deliberately shoots, bats, or throws"* it out, from anywhere; **10.1(v) reaches a goaltender who *"shoots or bats the puck directly out of the playing surface, with their stick"* — and, unlike (ii), it contains no deliberateness word at all.** ⚠️ **Treat what that omission means as a reading of the text rather than a settled rule, because the book does not resolve it.** What supports reading (v) as catching an accident is that Hockey Canada wrote *"deliberately"* into (ii) and left it out of (v), and that **Interpretation 5**, the one interpretation addressed to this limb — *"Clarifications as it pertains to goaltenders shooting or batting the puck directly out of play"* — lists the goaltender's escapes as the absence of glass, a puck that *"touches the glass or deflects off a player or official"*, and a rink whose two ends are not similar. Intent is not among them. What cuts the other way is the machinery above (v): Rule 10.1's preamble opens *"Delay of Game occurs when any player or team **deliberately** causes a stoppage of play"*, and 10.1(a) assesses the minor on a player *"who, in the opinion of the Referee, is **deliberately** delaying the game."* Nothing in the rulebook settles which reading wins, so if you keep goal under Hockey Canada, do not count on an accidental one being free. And **USA Hockey has no strict-liability equivalent either.** Rule 610(c) reaches only the player who "delays the game by **deliberately** shooting or batting the puck outside the playing area", and Rule 631(d) makes the accidental one a stoppage rather than a penalty: "if the puck is accidentally shot or deflected out of play … a last play face-off will occur in the zone where the puck was shot or the deflection occurred." Under that book the panicked clear over the glass costs you a defensive-zone draw, not two minutes.

⚠️ **Hockey Canada does attach a consequence to the accidental one, and in two divisions it is the thing you were clearing for.** **Rule 6.4(a)** provides that *"in Junior and Senior divisions, where a player of the defending team, excluding the goaltender, unintentionally shoots, bats, throws, kicks, or otherwise directs the puck outside the playing surface, no penalty will be assessed, but the defending team may not make a line change."* So if you play Junior or Senior under that book, the panicked clear buys you no change — and getting tired legs off the ice is usually most of the reason for it. Its **Note 1** sends a deliberate one straight back to the penalty: *"If the player deliberately shoots, bats, or throws the puck outside the playing surface, they must be penalized, as per Rule 10.1 (ii) – Delay of Game."* **Interpretation 1** confines 6.4(a) to pucks *"last legally touched in the end-zone"*, and its Example 2 shows how narrow *"unintentionally… directs"* is read — a clear that deflects off a **teammate** in the neutral zone and goes out is a neutral-zone draw and *"a line change would be permitted."* Note also what the rule does **not** say: it names kicking and *"otherwise directs"*, so it is not confined to a stick clear, and it says nothing about glass. **Below Junior and Senior it does not apply at all** — and nowhere in the book is there a strict-liability glass-out limb for a skater, so outside those two divisions an accidental clear over the glass is neither a penalty nor a restriction, while a deliberate one is still 10.1(ii)'s minor. The phrases *"over the glass"* and *"protective glass"* do not appear in it; its single *"no glass"* sits in Interpretation 5 to Rule 10.1, which is about goaltenders.
...
Rule: Under USA Hockey a hand CLOSED on the puck outside the crease and not opened immediately is a stoppage and a last-play face-off, not a penalty (618(a)) — but only a hand closed on it, and in the crease that same act is the penalty shot or optional minor (614(b), 618(a))
Rule: Picking the puck UP off the ice with the hand while play is in progress is a different act and a minor anywhere — USA Hockey 618(a) second paragraph, and NHL and IIHF 67.2(III) alike
...
```facts
Rule: NHL 52.2 is a mandatory match penalty with no lower tier; IIHF 52.2 a discretionary major plus automatic game misconduct; USA Hockey 639 a minimum major plus game misconduct with a match above it (639(c)); Hockey Canada 8.8 a double minor rising to a match
Rule: Hockey Canada's carve-out does not reach a slide called as clipping or slew-footing — 8.6 hands those to 8.7 and 8.8, which carry no carve-out and both reach a match penalty
...
Never: Foul the puck carrier from behind — backchecking hard is the right play, but a trip, hook, hold or slash there invites a penalty shot, and a check from behind ends your game in three books of four
Rule: A check from behind has no minor option under the NHL or IIHF (43.2 in each); Hockey Canada's floor is a minor plus a game misconduct (7.5(a), (e)), and only USA Hockey lets you finish the game (608(a))
