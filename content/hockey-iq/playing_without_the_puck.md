...
**Racing an opponent to a loose puck along the wall is a race into head-on contact with the boards, and the posture you arrive in is what decides the cost.** USA Hockey's *Heads Up Hockey* materials, citing Tator et al., attribute *"almost all on-ice cervical spine injuries"* to a head *"slightly flexed (head down) while making head-on contact with the boards or goal post"*, and add that *"a player doesn't have to be going at full speed for this to happen — it can occur at walking speed."* Get there with your skates parallel to the wall, head up and chin off your chest, and take the contact on your forearm and hip — not the point of your shoulder. Never turn your back to the wall, and never duck.

**When the other team has the puck, whether you may use your body at all is a question about your league.** Stick on the puck first, body on the player second — and body checking is banned outright in younger age groups and in all girls' and women's play under both USA Hockey (Rule 604(a)) and Hockey Canada (Rule 7.3) — and under Hockey Canada in any other division a Member has approved as non-check, so age alone does not settle it. **USA Hockey has a second limb of its own, and it belongs to a different body:** Rule 604(a) adds that *"A local governing body may prohibit body checking in any classification"*, so your own association can take checking away from an age group the printed list leaves in. **And for an adult the age list does not settle it:** USA Hockey's Glossary names *Adult non-check* among the four adult classifications it lists, and 604(a) bars body checking in all of them — how many leagues sit there is not something a rulebook records. **In Britain neither book states an age. Ask your league.** Find out which you are in before you play a shift.
...
**USA Hockey's own puck-possession study** of the 2002 Olympic Winter Games and the 2002 Youth Tier I National Championships puts the **men's per-game average at 1:07** with the puck (1:01.4 in the men's gold-medal game itself). ⚠️ **Read those figures as the governing body's own report rather than as a study you can go and check.** USA Hockey publishes the whole thing as a single page of summary figures inside its *Small Area Competitive Games* handbook, and that handbook — the only place the study appears, as far as this document has been able to establish — states no method, no number of players and no definition of a puck touch. Different era, and no stated method to set against the tracking work above — what the two share is the order of magnitude.
...
> **Caveat, stated once and applying to all of the above:** the possession figures are 5-on-5 only and are normalised per 20 minutes of ice time. Real ice time includes power plays and penalty kills, where possession patterns differ. The NHL calls this dataset unofficial and it may differ from hand-labelled data. The arithmetic combining possession rates with ice time and shift length is mine, not the researchers'. Treat the numbers as the right *shape*, not as decimals to defend.
...
Rule: Check whether you may hit at all — USA Hockey 604(a) bans body checking at 12U and below, in all girls'/women's and non-check adult classifications, and wherever a local governing body has prohibited it; Hockey Canada 7.3 bans it at U13 and below, in female hockey and any Member-approved division
...
Priority: Then take away the shooter's stick, not the puck. Lift it below their bottom hand, or seal the blade. The lift goes up, not sideways
...
- **Find the most dangerous man, not the puck.** In transition the puck carrier is usually not the threat — the man arriving late into the middle is. **That the man arriving late into the middle is more dangerous than the carrier is coaching emphasis rather than a counted ranking**; [Defending the Rush](../systems/defending_the_rush.md) owns it and states the limit with it.
...
```facts
Rule: You are allowed the ice you are standing on and are not required to move in order to let an opponent proceed (NHL Rule 56.1 and IIHF Rule 56.1, Interference — the IIHF writes it in the plural, so it is the British rule too)
Rule: You may block an opponent's path provided you are in front of him and moving in the same direction (NHL Rule 56.1 and IIHF Rule 56.1, Interference, in the same terms)
Rule: Moving laterally without establishing body position and then making contact with a non-puck carrier is penalised as interference — NHL Rule 56.1 and IIHF Rule 56.1 write that sentence in the same words, so it is the British rule too
...
Rule: You are always entitled to use body position to lengthen an opponent's path to the puck, without your stick, your free hand or an otherwise illegal check (NHL Rule 56.1, and IIHF Rule 56.1 in the plural)
Action: Run your route close past a teammate so your check has to go around them — legal traffic on almost every faceoff and net drive. Past them and shout, not into where they stand
Never: Stop in a defender's path and take the contact, or drift sideways into a chaser
Key: "Screen" here means the goaltender's sightline and nothing else — NHL Rule 56's words for skater-on-skater work are body position, blocking, picks and interference, so call yours traffic, or a route
...
Using a teammate's body to separate from your check is legal within limits, and the limits are precise. The NHL rulebook (Rule 56, Interference) defines them — **and the IIHF's Rule 56.1 prints the same paragraph, in the plural and with its defined terms in quotation marks, so a British reader is under these limits too.** The quotations that follow are the NHL's wording; where the IIHF's differs in a way that matters it is flagged.
...
⚠️ **That answers the legality question and stops, and the safety question is a different one.** The collision you are engineering is a defender at chase speed into a teammate who is standing still and facing away, and who cannot see them coming. Give them a shout as you come, and run *past* your teammate rather than into the space they are standing in. **That is a coaching caution, not a rulebook requirement** — the rules above are about what the officials will call, and nothing in them asks this of you.
...
```facts
Rule: Rule 69.1's clause (1) — an attacker who "either by his positioning or by contact" impairs the goalkeeper — sits under "Goals should be disallowed only if", a ceiling on disallowance rather than a direction to disallow (NHL and IIHF Rule 69.1)
...
Key: Screening from outside the crease without contact is legal — 69.1's disallowing sentence is keyed to an attacker who "enters the goal crease", and 69.4, for outside it, reaches contact only
```
...
- **Keep both skates off the red crease line, not merely out of the blue paint.** Outside the crease and touching nobody, the screen is legal — but the crease *edge* is where the books disagree, and three of the four put the red line inside the crease: **IIHF Rule 1.7** (*"The marked line belongs to the Goal Crease"*), **USA Hockey's Note to 625(b)** (*"including crease lines"*) and **Hockey Canada's Glossary** (*"The lines of the crease are considered part of the crease"*). Only the NHL leaves it unsaid, and inside the crease your position alone can cost the goal in every book. Work off the red line.
...
Never: Decide for yourself mid-rush to chase the puck carrier. Cover a lane instead — the man arriving unmarked into the middle is usually the more dangerous: coaching emphasis, not a counted ranking
...
Rule: ⚠️ Never finish into a carrier's back — no book prices it at a bare minor. The NHL and IIHF have no minor tier (43.2), leaving 43.3's major plus a game misconduct; Hockey Canada's minor adds one (7.5(a), (e)); USA Hockey's minor adds a ten-minute misconduct, not an ejection (608(a), 404(a))
Rule: ⚠️ That minor tier is a floor, not the price near the boards — USA Hockey 608(b) makes the major plus a game misconduct mandatory where the opponent goes head first into the boards or goal frame, and three of the four books reach a match penalty (608(c), Hockey Canada 7.5(c), NHL 43.4)
Risk: ⚠️ A spinal-injury mechanism, not a tariff question — Hockey Canada's Rule 7.5 preamble tells referees to be "aware of the tragic consequences of spinal injuries"
...
Convention: Which lane is yours is a coaching choice — the one used throughout gives the centre the middle and the wingers the outside; alternatives are first man back takes the middle and man-on-man from the puck outward. Under every one, somebody owns the middle and nobody assumes it is somebody else
...
- **Do not chase the puck carrier. Take your lane.** Your instinct is to chase the carrier. Resist it, unless your team has specifically told you to: some teams coach the first forward back to pressure the carrier and have the defence hold inside, and if that is your system it is an instruction rather than an instinct. Absent that instruction, take the lane. **And pressuring never means finishing into a carrier's back.** ⚠️ **Under the NHL and the IIHF there is no lower gear to fall back on.** NHL **Rule 43.2** is one sentence — *"There is no provision for a minor penalty for checking from behind"* — and the IIHF's **43.2** says the same with its reason attached: *"This infraction is considered serious and dangerous, therefore there is no option to award a minor penalty for 'Checking from Behind'."* What is left is **43.3**, a major, and a game misconduct that NHL **43.5** says *"must be assessed anytime a major penalty is applied for checking from behind"* — the IIHF folds the pair into 43.3 itself, *"a major penalty and an automatic game misconduct penalty"*. **And it applies anywhere on the ice, not only along the boards** — NHL 43.3's own words are *"anywhere on the playing surface"*. ⚠️ **And near the boards the minor tier is not what this play costs.** **Three of the four books reach a match penalty for a check from behind**, and the two that write a minor take it away the moment the opponent goes head first into the boards or cannot protect themselves. USA Hockey **608(b)**: *"A major penalty plus game misconduct penalty shall be assessed to any player who recklessly endangers an opponent, or causes them to go head first into the boards or goal frame, as a result of checking from behind"* — *shall*, not *may* — and **608(c)** adds a match penalty *"in all instances when a player recklessly endangers an opponent from behind with excessive force while the opponent is in a vulnerable or defenseless position"*. **Hockey Canada writes that same hit as a mandatory match penalty**, its **7.5(c)** reading *"A Match penalty will be assessed to any player who pushes, body-checks, cross-checks, or hits an opposing player in any manner from behind into the boards or goal frame, in such a way that the player is unable to protect or defend themselves"* — *will*, not *may*. And its **7.5(b)** reaches a major plus a game misconduct on *"the degree of violence of the impact"*, and makes that pairing compulsory the moment the hit injures: *"If a player is injured, as the result of a checking from behind infraction that would otherwise call for a Minor penalty, a Major penalty and Game Misconduct penalty must be assessed."* The **NHL's 43.4** is a match penalty at the referee's discretion, *"if, in his judgment, the player attempted to or deliberately injured his opponent by checking from behind"*. **The IIHF is the fourth book, and it has no match penalty to reach** — the phrase appears nowhere in either the 2025/26 (v1.1) or the 2026/27 edition, and its Rule 43 stops at 43.3's major and automatic game misconduct. ⚠️ **And the backchecker's play is the exact case USA Hockey's Casebook draws the line through.** At **Rule 608, Situation 1** the minor plus misconduct *"must be assessed"* where *"[a] player, in an attempt to catch an opponent who is skating ahead of them and not near the boards, pushes the opponent from behind, causing them to fall to the ice"* — but the major plus game misconduct is required *"[i]n every instance where a player forcefully checks an opponent who is standing along the boards"*, *"[i]n every instance where a player is thrust head first into the boards or goal frame"*, and in every instance of reckless endangerment *"regardless of whether or not board contact is made"*. The same Situation names a *"danger zone"* — *"the area approximately ten feet out from the boards"*, where a player checked from behind *"may be at high risk of receiving a serious and possibly life altering injury."* **Hockey Canada's rule opens on the same picture**, its Rule 7.5 preamble telling referees to be *"aware of the tragic consequences of spinal injuries"* and listing among the cases referees must enforce strictly the player *"along the boards, with their head down looking for the puck or 'digging the puck out,'"* who is *"hit from behind and driven head-first into the boards."* ⚠️ **Two of the four books do write a minor tier, and you should know that before you assume yours does not — but not one of them prices this at a bare two minutes.** Hockey Canada **7.5(a)** assesses *"A Minor penalty and a Game Misconduct penalty… to any player who intentionally pushes, body-checks, cross-checks while in motion, or otherwise hits an opposing player from behind, anywhere on the ice"*, and **7.5(e)** makes that pairing compulsory — the game misconduct *"must be assessed any time a Minor or Major penalty is assessed"* — **so Hockey Canada's minor still ends your game.** **USA Hockey is the one book of the four that lets you finish it**, its **608(a)** reading *"A minor plus a misconduct penalty, or a major plus a game misconduct penalty, shall be assessed for checking from behind"*. ⚠️ **Do not price that at two minutes either.** A USA Hockey misconduct is a further ten minutes under **404(a)** — *"the removal of a player… from the game for a period of 10 minutes"*, which affiliates may shorten to six or eight minutes where periods are short, though the Note that allows it is expressly *"(Except for Adults)"* — a second one in the same game becomes a game misconduct *"in lieu of the second misconduct penalty"*, and a USA Hockey game misconduct also suspends you for your team's next game (**404(b)**). **The four books differ on the price. None of them differs on the play.** The dangerous man is usually the one arriving unmarked into the middle lane — coaching emphasis rather than a counted ranking — and covering a lane is worth more than catching the carrier from behind, from which position, incidentally, you are not permitted to restrain them at all. **Which rule catches you depends on whether they have the puck.** Behind an opponent who does *not* have it, restraint is interference — NHL Rule 56.1: *"A player who is behind an opponent, who does not have the puck, may not use his stick, body or free hand in order to restrain his opponent, but must skate in order to gain or reestablish his proper position in order to make a check"*, and the IIHF's 56.1 says it word for word in the plural. **That clause does not reach the puck carrier**, whom it excludes in its own words — but holding and hooking do, and neither is conditional on possession. NHL Rule 54.1 defines holding as *"any action by a player that restrains or impedes the progress of an opposing player whether or not he is in possession of the puck"*, and Rule 55.1 makes hooking *"the act of using the stick in a manner that enables a player to restrain an opponent"*; the IIHF's 54.1 and 55.1 carry both definitions in the plural, its 55.1 adding a sentence about the stick going against or near the opponent's hands. So whichever rule applies, skating is the only legal way back into position. **Which lane is yours is a coaching choice.** Under the standard assignment used throughout, the **centre takes the middle lane and the wingers take the outside lanes** — so as a winger, "take the middle" is not your instruction unless you are the first man back and nobody else has it. Alternatives are **first man back takes the middle** and **man-on-man from the puck outward**. Find out which your team plays; [Defending the Rush](../systems/defending_the_rush.md) sets them out, along with the four named team backchecking systems that decide which assignment applies. Under every one of them, somebody owns the middle and nobody assumes it is somebody else.
...
Action: Go to the rebound rather than admiring your shot. Take one more stride when you get beaten wide
...
Two words in the defenceman's line are easily confused. A **pinch** is stepping down from the *offensive* blue line to keep a puck in their end; **stepping up** is challenging an attacker forward, in the neutral zone or at your own line. Different decisions, in different halves of the rink.
...
4. **On the loose pucks, did I arrive with body position or just with speed — and did I arrive the safe way round: skates parallel to the wall, head up and chin off my chest, never my back to it, and the contact on my forearm and hip rather than the point of my shoulder?**
...
- **Training only the 3-4%.** Spending every spare hour on stickhandling while never once thinking about where to be. The 3-4% is puck possession measured at 5-on-5, from NHL tracking data the league itself calls unofficial. Skill work is necessary and it is not the majority of your game.
- **Assuming your age group settles whether you may body check.** Both North American books let somebody other than the age list decide, by different routes. USA Hockey Rule 604(a) provides that *"A local governing body may prohibit body checking in any classification"*; Hockey Canada Rule 7.3 extends its own prohibition to *"any other divisions approved by a Member of Hockey Canada"*. So a 14U or an adult team can be playing non-check with nothing in the printed age list changing. Ask your association or league, and get the answer before the first shift — under USA Hockey a body check in a Competitive Contact category is a minor (604(c)), a major plus a game misconduct where it recklessly endangers (604(d)), and 604(e) reaches a match penalty. **In Britain neither the IIHF Rule Book nor the In-House Rules states a checking age at all**, so there the answer belongs to your league and to nobody else.
...
- **Finishing a backcheck into the back of the man you could not catch.** ⚠️ **This is the one mistake in this document that can end somebody's season, and the section that sets it up is the one about effort: backchecking hard is sprinting at somebody's back.** You are late, they are facing the boards with their head down, and the last stride turns into a check from behind. **Not one of the four rulebooks prices that at two minutes.** The NHL and the IIHF write no minor tier at all (43.2); Hockey Canada's minor comes with a game misconduct (7.5(a), 7.5(e)); USA Hockey's comes with a ten-minute misconduct (608(a), 404(a)). ⚠️ **And near the boards it is worse than that in three of the four books.** USA Hockey **608(b)** makes the major plus a game misconduct mandatory where the check *"causes them to go head first into the boards or goal frame"*, **608(c)** a match penalty, and Hockey Canada **7.5(c)** a match penalty for the same hit; the **NHL's 43.4** reaches one at the referee's discretion. ⚠️ **The reason is not the penalty sheet.** USA Hockey's Casebook calls the ten feet nearest the boards a *"danger zone"* where a player checked from behind *"may be at high risk of receiving a serious and possibly life altering injury"*, and Hockey Canada's Rule 7.5 preamble tells referees to be *"aware of the tragic consequences of spinal injuries"*. **Take the lane, or let up. There is no version of this worth the risk, and no league — checking or not — where it is legal.**
...
3. **Find out whether you may use your body at all before you play a shift.** Body checking is banned under USA Hockey Rule 604(a) at 12U and below and in all girls'/women's and non-check adult classifications, and under Hockey Canada Rule 7.3 at U13 and below, throughout female hockey and in any Member-approved division. **Both books also let somebody other than the age list decide, by different routes:** USA Hockey 604(a) provides that *"A local governing body may prohibit body checking in any classification"*, and Hockey Canada 7.3 extends its own prohibition to any division a Member approves — so ask your association which category you actually play in. **In Britain neither book states an age. Ask your league**, and note that British women's hockey runs IIHF Rule 101.1 unamended: bodychecking only with a clear intention of playing the puck or attempting to *"gain possession"* of it, subject to the exception the rule itself then sets out; any move to step or glide into an opponent is at least a minor, running up to a major plus an automatic game misconduct. Where it is not permitted, defending off the puck is angling, stick checks and body position.
...
9. **Win loose pucks with body position and a decided exit, not just speed — and safety outranks all of it.** A puck race to the wall is a race into the boards, and a head-down, head-on arrival is what *Heads Up Hockey* ties almost all on-ice cervical spine injuries to — at walking speed as much as at full speed — so get your **skates parallel to the boards**, head up and chin off your chest, and take it on your **forearm and hip — not the point of your shoulder**. **Never turn your back to the wall, and never duck.** See [Body Contact and Battles](../technique/body_contact_and_battles.md), §6.
10. **Off-puck effort is the cheapest thing to improve — and there is exactly one thing it must never buy.** Backcheck into your lane, finish your route, take the second stride: none of it needs a skill you do not already have. **But never finish a backcheck into a player's back.** Arriving late on somebody facing the boards, take the lane or let up. **No book of the four prices checking from behind at a bare minor**, three of them reach a match penalty (USA Hockey 608(c), Hockey Canada 7.5(c), NHL 43.4), and USA Hockey's Casebook calls the ten feet nearest the boards a *"danger zone"* where the player checked *"may be at high risk of receiving a serious and possibly life altering injury."* **That holds in every league, checking or not.**
...
- The **interference and pick rules** are quoted from the **NHL Official Rules 2025-2026**, Rule 56.1, and the **holding and hooking** definitions in the backchecking section from Rules 54.1 and 55.1 of the same book. **Note what Rule 56.1 does not cover:** its "Body Position" paragraph is written for *"an opponent, who does not have the puck"*, so it does not reach a player restraining the puck **carrier** from behind; that is holding under 54.1, which applies *"whether or not he is in possession of the puck"*, or hooking under 55.1, which sets no possession condition. The IIHF equivalents were read in the **2025/26 Rulebook (Version 1.1, July 2025)**: its 54.1, 55.1 and 56.1 carry the same wording in the plural, its 55.1 adding a sentence about the stick going against or near the opponent's hands. **56.1's "Body Position" paragraph and its "Pick" definition differ from the NHL's only in the plural pronouns, the capitalised *Player*, one added comma, and quotation marks around the IIHF's defined terms** — *"establishing body position"*, *"interference"*, *"body position"*, *"free hand"* — and the lateral-movement sentence is word for word identical bar two of those quotation-mark pairs. **The same paragraph is byte-identical in the 2026/27 Rulebook (Version 1.0, June 2026)**, so nothing here turns on which IIHF edition a British league is sitting on.
