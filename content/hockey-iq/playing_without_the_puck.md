...
Rule: The after-the-whistle words are in three of the four books — NHL and IIHF 63.2(ii) and USA Hockey 610(c); Hockey Canada 10.1(ii) has none, but its Rule 10.1 preamble reaches delaying the restart of play
...
Rule: USA Hockey 607(c) is a minor plus a misconduct, or a major plus a game misconduct, for body checking or charging a goalkeeper inside the crease or privileged area; 607(d) says they are not "fair game" outside it either, and unnecessary contact is penalised there too
