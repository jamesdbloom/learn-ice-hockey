...
Position: Keep both skates off the red crease line, not merely out of the blue — the IIHF, USA Hockey and Hockey Canada all count that line as part of the crease, and only the NHL leaves it unsaid
...
- **Keep both skates off the red crease line, not merely out of the blue.** Outside the crease and touching nobody, the screen is legal — but the crease *edge* is where the books disagree, and three of the four put the red line inside the crease: **IIHF Rule 1.7** (*"The marked line belongs to the Goal Crease"*), **USA Hockey's Note to 625(b)** (*"including crease lines"*) and **Hockey Canada's Glossary** (*"The lines of the crease are considered part of the crease"*). Only the NHL leaves it unsaid, and inside the crease your position alone can cost the goal in every book. Work off the red.
