...
- **If you are genuinely beaten and can only chase**, chase the *stick*, not the body: get your blade under theirs or on the puck. Reaching around their body from behind is a hook or a trip, and near your own net that gets expensive (see the breakaway section below).
...
- **The single biggest danger is both defenders drifting to the puck.** It is magnetic and it is fatal: two of you converge on the carrier, they make a simple pass, and their partner has the net. If you are the defender on the non-puck attacker, your job is to *stay with them* and let your partner do theirs.
...
2. It was committed **from behind**.
...
```facts
Action: Stick on the puck only — if your blade is not touching the puck or their blade, you are probably committing a penalty
Rule: Make contact with the puck first and a tripping minor replaces the penalty shot — NHL 57.3 and IIHF 24.8, same words. USA Hockey 616(a) counts a foul diagonally from behind too and leaves an optional minor; its poke-check carve-out sits in 639(a) and may not reach 616 at all
...
Rule: The ceiling above the minor differs by book — NHL 21.1 and USA Hockey 602(a)/639(c) reach a match penalty, Hockey Canada's 7.1(c) is residual and 8.6(c) bars a match for tripping, and the IIHF writes no match penalty anywhere
...
Rule: USA Hockey and Hockey Canada keep the "from behind" test with the net empty — USA Hockey 616(b) awards it only via the "fouled from behind provisions", and Hockey Canada 4.12(a) routes through 4.11(a)(i)
...
```facts
Rule: All four books let you catch a puck out of the air, provided you immediately knock it down or place it on the ice — NHL and IIHF 67.2, USA Hockey 618(a), Hockey Canada 10.2(a)(iii), which adds "without gaining or attempting to gain an advantage"
...
Rule: What buys the penalty is the conduct after the catch, not the height — holding it, taking a stride, turning to avoid a check, or throwing it (NHL and IIHF 67.2(I); Hockey Canada Interpretation 4 to 10.2(a)(iii))
...
Rule: With your own net empty that becomes an awarded goal — NHL and IIHF 67.5 and Hockey Canada 10.2(a)(vi) on the bare fact of the substitution; USA Hockey alone conditions it, awarding it only where the act "has prevented an obvious and imminent goal" (614(b), 618(a))
...
**The permission first, because it is what makes the act free.** All four books expressly let you catch a puck out of the air, provided you put it straight back down. NHL and IIHF **Rule 67.2**, in identical words: *"A player shall be permitted to catch the puck out of the air but must immediately place it or knock it down to the ice."* Hockey Canada's **10.2(a)(iii)** excludes the honest catch from the minor in terms — it *"will not include a player who closes their hand on the puck to catch or stop the puck and immediately drops it to the ice without gaining or attempting to gain an advantage."* And **outside the crease, USA Hockey 618(a)** does not reach a penalty at all: a hand that does not open immediately means *"Play shall be stopped and a last play face-off shall occur"*, its minor being reserved for a player who *"picks the puck up from the ice with their hand(s) while play is in progress."* ⚠️ **In the crease that same rule is the penalty shot or optional minor, because a hand that closes and does not open is holding the puck** — 618(a)'s own third paragraph reaches a defending player other than the goalkeeper who *"picks the puck up off the ice with their hand **or holds the puck** while play is in progress **and the puck is in the goal crease**"*, and **614(b)** says it again: *"or uses the hands to hold the puck while in the goal crease."* **Knock it down and no book penalises you.**
...
- Note the symmetry: this is the same play your own team should be running in attack, described from the other side in [Defender](../positions/defender.md) under activating, and in [Zone Entries](zone_entries.md).
...
- It rewards a skilled carrier who chips the puck past you and skates onto it.
...
- Reliable and repeatable, which is why it is the default for most defencemen most of the time.
...
- **"Back door!"** — an attacker is arriving unmarked at the far post. The single most urgent call in defensive hockey.
...
- **Reading "puck first" as a licence.** It saves you the penalty shot under the NHL and IIHF books and nothing more. USA Hockey's sits elsewhere — 639(a)'s Note excuses a clear poke- or hook-check, though whether it reaches a 616 penalty shot is unclear. Hockey Canada writes a wide one, and 8.6 extends it to a deliberate slide expressly. What it does **not** cover is a slide that catches them **below the hips** — that is clipping under 8.7, which carries no carve-out at all and reaches a match penalty at the top. And no book anywhere caps a deliberate attempt to injure at a minor (NHL Rule 21.1).
...
*Not used as sources: the Ice Hockey Systems, The Coaches Site, USA Hockey and Hockey Canada coaching pages, none of which are publicly accessible — they sit behind a 403 or a login as of 27 July 2026. The rules quoted in this document are taken from the primary rulebook texts themselves — *NHL Official Rules 2025-2026* (Rules 1.7, 21.1, 25.1, 43.2, 52.1, 52.2, 57.2, 57.3, 57.4, 63.6, 67.4, 67.5), the *IIHF Official Rule Book 2025/26* (Rules 1.7, 24.8, 25.3, 43.2, 52.2, 57.3, 57.4, 63.6, 101.1), the *IIHF Situation Handbook 2025/26* (Situation 63.27 against Situations 63.15 and 67.4, on whether a puck above the crossbar is in the crease — in all three of which the player *"turns to avoid"* opponents before releasing the puck, so the conduct and not the height is what produced the penalty — and Situation 67.6, where a defender with his own net empty takes the puck *"out of mid-air (around the height of the waist)"* and drops it **outside** the crease, ruled *"an Awarded Goal"* — a Handbook whose Foreword ranks it below the Rulebook), the *USA Hockey Official Rules of Ice Hockey 2025-29* (Rules 406(a), 602(a), 604(a), 614(b), 616 incl. 616(b), 618(a) — under which a hand closed **outside** the crease and not opened immediately is not a penalty at all but *"Play shall be stopped and a last play face-off shall occur"*, while a hand closed on a puck that is *in* the crease is the penalty shot or optional minor, the minor being reserved for a player who *"picks the puck up from the ice with their hand(s) while play is in progress"* — 630, 639 incl. 639(b) and 639(c)) and the [*Hockey Canada Playing Rules 2026-2028* (PDF)](https://cdn.hockeycanada.ca/hockey-canada/Hockey-Programs/Officiating/Downloads/2026-28-hc-rulebook-e.pdf) (Rules 4.11(a)(i), 4.11(a)(v) — the penalty shot for a **hand** that picks the puck up *"while the puck is in the goal crease"*, which is the hand limb only — Rule 1.5(c), Rule 4.11's preamble and the Rule 10.2 preamble, permitting a player *"to stop, knock down, or push the puck with their hand"*, and Interpretation 4 to 10.2(a)(iii), listing the three acts that do produce the minor — throwing it, manoeuvring around a player while holding it, taking a stride with it; Rule 10.2(a)(iii)–(vi), whose hand limb excludes *"a player who closes their hand on the puck to catch or stop the puck and immediately drops it to the ice without gaining or attempting to gain an advantage"*, with Interpretation 5, which rules on the **body** limb and reasons that *"The puck was not actually covered in the crease"*, and 4.12(a), Rule 7.1(c), Rule 7.3(a) and its Interpretation 1, Rule 8.6 and its Interpretations 1 and 2, Rule 8.7 Clipping and its Interpretation 2, Rule 8.8 Slew-Footing and its Interpretation 1) — not from a blog summarising them. The rush-danger figures quoted in the overview are sourced (NHL.com/Sportlogiq and the 2013 MIT Sloan zone-entry paper, both linked above), with one limit stated where they appear: Sportlogiq's per-situation table is published as a graphic, so the size of the odd-man multiplier is given in the source's own words — "almost triples" — rather than as a number.*
