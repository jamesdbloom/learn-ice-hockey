...
- **Uses the offside rule as an extra defender.** Because under NHL and IIHF rules both skates must cross after the puck (and under USA Hockey Rule 630(a) the attacker needs skate *contact* with the line or the neutral zone, which is stricter still), a defender squeezing the line can force the carrier to slow up or enter alone. A delayed offside also lets your team reset while the attackers tag up.
...
6. **Chasing a lone attacker from behind, your stick goes on the puck and nothing else.** Under NHL Rule 57.3 a foul from behind that denies the chance is a penalty shot rather than a two-minute penalty — but if you play the puck first and trip them in doing so, **NHL Rule 57** stops at a minor (57.2) — though 21.1 still reaches a match penalty for a player who deliberately injures an opponent *"in any manner"* — which is the whole reason the instruction is stick-on-puck. ⚠️ **The IIHF book gives the same carve-out at 24.8 and the same minor — but not the same ceiling:** its 57.3 reaches a major and 57.4 a major plus a game misconduct for reckless endangerment, which the NHL's tripping rule has no equivalent of, and **tripping 57.4 is on Reference Table 7**, where a first major lets the referee end your game — that table is headed *"based on the Referee's judgement"*, so it is discretionary rather than automatic, which is Table 6. With your own net empty there is no "from behind" test at all: any foul that denies the goal is an awarded goal (NHL Rules 25.1 and 57.4), and stepping across from the front does it. The IIHF's Rule 24.8 mirrors 57.3; USA Hockey's Rule 616(a) is materially different and leaves the referee a minor penalty instead, so know which book you are under. **Under Hockey Canada the carve-out does reach a deliberate slide** — 8.6 says so in the same sentence that defines one. What it does not reach is a slide landing **below the hips**, which is clipping under 8.7: no carve-out, a major plus game misconduct on the degree of violence alone, and a match penalty at the top. Slew-footing (8.8) has no major tier at all — 8.8(b) bars the major and 8.8(e) the game misconduct — and runs from a double minor straight to a match penalty.
...
*Not used as sources: the Ice Hockey Systems, The Coaches Site, USA Hockey and Hockey Canada coaching pages, none of which are publicly accessible — they sit behind a 403 or a login as of 27 July 2026. The rules quoted in this document are taken from the primary rulebook texts themselves — *NHL Official Rules 2025-2026* (Rules 43.2, 57.2, 57.3, 57.4, 67.4, 67.5), the *IIHF Official Rule Book 2025/26* (Rules 24.8, 43.2, 57.3, 57.4), the *USA Hockey Official Rules of Ice Hockey 2025-29* (Rules 604(a), 616, 639) and the [*Hockey Canada Playing Rules 2026-2028* (PDF)](https://cdn.hockeycanada.ca/hockey-canada/Hockey-Programs/Officiating/Downloads/2026-28-hc-rulebook-e.pdf) (Rule 7.3(a) and its Interpretation 1, Rule 8.6 and its Interpretations 1 and 2, Rule 8.7 Clipping, Rule 8.8 Slew-Footing) — not from a blog summarising them. The rush-danger figures quoted in the overview are sourced (NHL.com/Sportlogiq and the 2013 MIT Sloan zone-entry paper, both linked above), with one limit stated where they appear: Sportlogiq's per-situation table is published as a graphic, so the size of the odd-man multiplier is given in the source's own words — "almost triples" — rather than as a number.*
