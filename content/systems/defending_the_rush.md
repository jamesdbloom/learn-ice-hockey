...
Rule: Covering a puck that is itself in your goal crease is a penalty shot under NHL 67.4, goalkeeper excepted — the puck's position decides, not yours (63.6) — and with your net empty it is an awarded goal (67.5)
...
*Rules: [NHL Official Rules 2025-2026 (PDF)](https://media.d3.nhle.com/image/private/t_document/prd/slwjuaqwmuvj5bkplixo.pdf) — Rule 57.3 Penalty Shot (the four criteria, the puck-first carve-out, and the no-whistle-until-possession-is-lost provision), Rule 57.4 Awarded Goal, Rule 67.4/67.5 Handling the Puck in the Crease, Rule 24 Penalty Shot procedure, Rule 25 Awarded Goal. Verified verbatim against the rulebook text · [IIHF Official Rulebook 2025/26](https://www.iihf.com/en/statichub/8635/rulebook) — Rule 24.8, which mirrors NHL 57.3 with an added goalkeeper-from-the-front exception · [USA Hockey 2025-29 Official Playing Rules](https://cdn2.sportngin.com/attachments/document/945a-3442848/2025-29_USAH_Playing_Rules.pdf) — Rule 616(a), a materially different peripheral-vision-and-breakaway test with referee discretion to assess a minor instead · [Penalty Shots — Scouting The Refs](https://scoutingtherefs.com/2023/11/42060/penalty-shots-how-do-they-work-when-are-they-called/) — supporting commentary only*
...
*Not used as sources: the Ice Hockey Systems, The Coaches Site, USA Hockey and Hockey Canada coaching pages, none of which are publicly accessible — they sit behind a 403 or a login as of 27 July 2026. The rules quoted in this document are taken from the primary rulebook texts themselves — *NHL Official Rules 2025-2026* (Rules 21.1, 25.1, 43.2, 52.1, 52.2, 57.2, 57.3, 57.4, 67.4, 67.5), the *IIHF Official Rule Book 2025/26* (Rules 24.8, 25.3, 43.2, 52.2, 57.3, 57.4, 101.1), the *USA Hockey Official Rules of Ice Hockey 2025-29* (Rules 602(a), 604(a), 616 incl. 616(b), 630, 639 incl. 639(b) and 639(c)) and the [*Hockey Canada Playing Rules 2026-2028* (PDF)](https://cdn.hockeycanada.ca/hockey-canada/Hockey-Programs/Officiating/Downloads/2026-28-hc-rulebook-e.pdf) (Rules 4.11(a)(i) and 4.12(a), Rule 7.1(c), Rule 7.3(a) and its Interpretation 1, Rule 8.6 and its Interpretations 1 and 2, Rule 8.7 Clipping and its Interpretation 2, Rule 8.8 Slew-Footing and its Interpretation 1) — not from a blog summarising them. The rush-danger figures quoted in the overview are sourced (NHL.com/Sportlogiq and the 2013 MIT Sloan zone-entry paper, both linked above), with one limit stated where they appear: Sportlogiq's per-situation table is published as a graphic, so the size of the odd-man multiplier is given in the source's own words — "almost triples" — rather than as a number.*
