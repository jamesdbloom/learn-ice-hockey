...
- **D1** (strong side) steps up on the wall if the puck gets past F2 — this is the most dangerous decision in the structure.
...
- **The strong-side defenceman** steps up hard on a pass to the wall — this is the aggressive gap that makes the whole thing work, and it is the riskiest decision on the ice.
...
3. **Take the late man.** A trailing attacker arriving unmarked into the high slot is one of the cheapest goals a team gives up off a rush — that is coaching consensus rather than a tracked figure; nobody publishes a breakdown of rush goals by cause. In the near-universal default the late man belongs to the **backchecking forwards**, not to the defencemen, who are occupied with the first wave; [Defending the Rush](defending_the_rush.md) covers that assignment and states it the same way. If your coach hands the trailer to the weak-side defenceman instead, that is a real alternative and you need to know which you are playing.
4. **Do not stop at the red line to wait for the counterattack.** This is the most expensive habit in amateur hockey. One forward hanging at the red line means the D must back off, which means a controlled entry against you, which means you are in your own zone for 40 seconds instead of the counterattack you were fishing for.
...
## Regroups — the most under-used tool in amateur hockey
...
Rule: A teammate's encroachment gets your centre ejected and a second team violation is a bench minor — an individual minor under USA Hockey 613(d), only a warning under IIHF (Faceoffs covers the split)
...
- **Dumping from your own side of the red line at equal strength.** Icing. You lose the zone, you lose the draw location, and **you cannot change your line** — a tired unit gets pinned for another 30 seconds.
