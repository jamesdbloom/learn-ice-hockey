...
Rule: Neither the IIHF Rule Book nor the In-House Rules state an age at which body checking becomes legal — ask your league
...
Rule: USA Hockey grants no window at all — 640(b) says a player who has released a shot or pass "are not eligible to be body checked"; that minor is written "except Adult Male Classifications", but 640 Note 2 reaches it there as roughing
...
Rule: A late hit is not capped at a minor — IIHF 56.5 reaches a major plus a game misconduct with nobody hurt, and Hockey Canada 8.3(b) reaches the same tier on "the degree of violence of the impact" with nobody hurt, and makes it mandatory where it injures
```
