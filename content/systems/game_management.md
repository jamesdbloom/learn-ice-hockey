...
**Game management is one question asked over and over: how much risk do the score and the clock allow right now?** Everything here that is not explicitly a rule is a coaching choice — your team may want something different, so ask rather than assume.

**Protecting a lead is an active job, not a passive one.** Manage the puck rather than the clock: no cross-ice passes through the middle of your own end, no long passes you are unsure of, and a chip past the forechecker and out beats forcing a breakout pass under pressure. Deny the middle, win the draws in your own end, and shorten your shifts to 30–35 seconds — a coaching prescription rather than a measured figure.

**Trailing, add risk in order, and know what each step costs.** Speed and support through the neutral zone first, because that costs you nothing defensively; then a more aggressive forecheck; then pinching defencemen — stepping down from the offensive blue line to keep a puck in, where a pinch that misses is a 2-on-1 the other way; then activating a defenceman into the rush, which is a genuine odd-man risk against you; then the goalie. Scale it to how much time is left against how many goals you need, not to how frustrated you feel — and someone is always the last player back, with the swap called out loud.

**The bad change is among the most expensive routine mistakes in hockey** — coaching consensus, not a measured ranking. Do not change while the puck is in your own end and your team does not have it, and do not change while you are the last player back. Go when your team has the puck heading north, has just put it in deep, or has completed a clear. And once your own team has iced the puck, the NHL and the IIHF bar you from changing at all before the ensuing faceoff, subject only to narrow exceptions.

**The analytics consensus is that coaches pull the goalie too late.** Expect to go earlier than feels natural — down two with four or five minutes left is normal, not desperate — and know the goalie comes out on your team's next favourable stoppage, not any stoppage. With the extra attacker on, get set up rather than entering the zone again and again, put pucks at the net with a body in front of it, move the puck first-touch, never let both of your point men pinch, and change only when you have possession.

**When the referee's arm goes up for a delayed penalty, an extra attacker is free.** Play continues until the offending team gains control of the puck, and until then they cannot score. So the goalie leaves at the first sign of the arm, the sixth skater jumps as he arrives, and nobody makes a blind pass across the front of your own goal — putting it in yourself is the sole way you can still be scored on (NHL Rule 78.5(xi)). Not every league allows or practises this, so agree it beforehand.

**Once your own goalie is pulled, no foul in your own end buys you anything.** Every trade that was worth taking with a goalie behind you — a penalty shot instead of a certain goal, for instance — stops being worth taking without one, because the rulebook skips the shot and simply awards the goal. If a loose puck is in your crease, knock it straight down where you stand: that is free in all four books.

**Defending against a pulled goalie, do not chase and do not fire it the length of the ice.** Hold a tight shape inside the slot, take sticks away at the net front, let them have the perimeter, and treat every clear as a shot at the empty net when the lane is clean. You can still be iced doing it — six players against six is equal strength, not below it — and under the NHL and the IIHF that icing costs you a draw in your own end, the line change and the time-out all at once.
...
The document runs through the situations roughly in the order a game hands them to you: what the score does to how both teams play, protecting a lead, pressing when you are behind, pulling your goalie and defending against a pulled one, matching lines, shift length and the moments not to change, overtime and shootouts, and the discipline decisions that settle close games.

**Trailing teams shoot more and leading teams shoot less.** That one is documented well enough that analysts rebuilt their shot-attempt measures around it, it grows as the deficit and the clock grow, and it distorts every raw statistic you will ever look at. Much of the rest of the evidence here is softer, and this document says so at each point rather than in a footnote: that the minute after a goal against is the most dangerous stretch in hockey is coaching lore rather than a measured hazard rate; that a bad change is among the costliest routine mistakes is coaching consensus rather than a counted ranking; and that most amateur penalties are frustration penalties is coaching experience that the published youth-hockey data partly contradicts.

**The other thing that qualifies everything here is which book your league runs.** Several of these tactics are shaped by rules your own book may not write. The bar on changing after your own icing and the refusal of a time-out after one are NHL, IIHF and PWHL answers; the coincidental-minors 4-on-4 is an NHL-and-IIHF one; Hockey Canada is often a third answer rather than a second; and USA Hockey frequently writes no such rule at all. 🇬🇧 **In Britain the IIHF flags are yours** — and in many fixtures there is no overtime whatever, so read **Overtime** and **Shootouts** before you rely on anything in them.

**Where a rule *is* the tactic, it is set out here in full rather than sent elsewhere.** How you lose the line change, what a time-out can and cannot buy you, what the referee's raised arm gives you for free, when a shorthanded team may ice the puck, and what a foul costs once your own net is empty are not background to the decision — they are the decision.
...
This is a well-documented result in hockey analytics: **teams that are trailing take more shots, and teams that are leading take fewer.** The effect is large, it is consistent, and it grows as the deficit grows and as the clock runs down.
...
Action: Shorten your shifts to 30–35 seconds when protecting a lead — a coaching prescription rather than a measured figure; fresh legs defend, tired legs reach
...
**4. Short shifts.** 30–35 seconds rather than 50 — a coaching prescription rather than a measured figure; the measured range is 30–80 seconds, in [Conditioning and Recovery](../off-the-ice/conditioning_and_recovery.md). Fresh legs defend; tired legs reach. A team that changes cleanly every 35 seconds late in a game is much harder to score on than a team of tired heroes.
...
Rule: None of the four books caps a late hit at a minor — IIHF 56.5 and Hockey Canada 8.3(b) reach a major plus a game misconduct with nobody hurt, 8.3(e) making that game misconduct automatic and 8.3(c) is a match above it; NHL 56.4 is a major on violence, its 56.5 game misconduct needing an injury
...
- **Icing is waved off if your team is shorthanded** — with two exceptions. Killing a penalty you may normally ice it freely, but under Rule 81.6 a team shorthanded *"by reason of a major penalty"* that has *"neglected to ensure there is a player on the penalty bench to exit upon the expiry of the penalty"* keeps playing a man short and *"are not permitted to ice the puck. Icing will be called."* ⚠️ **The NHL's ban bites at the moment the major runs out, not while it is being served, and it lasts only until the next stoppage.** What it catches is the clear fired in the window between the major expiring and the next whistle, when the team is — in **Rule 20.3**'s words — *"no longer short-handed by reason of a penalty"* and *"may substitute for this penalized player"* (Rule 81.6). ⚠️ **What buys the exemption is the count and not the major** — let them take a minor too and go 4-on-4 and you are *"equal or superior in numerical strength"* under **Rule 81.1**, major or no major, and icing is called. **The situation only arises where the penalised player was ejected or injured** — Rule 20.3 scopes the empty bench to a player who *"has been removed from the game or is injured"* — since on an ordinary major he is serving it on the penalty bench himself. And **USA Hockey restricts the exemption by classification**, to *"(For all Youth 15-Only and above, Girls 16U and above, High School and Adult classifications only)"* (Rule 624(b)(1)) — below those levels a shorthanded team cannot ice the puck at all, so a kill built on length-of-the-ice clears just feeds the power play defensive-zone draws. [Special Teams](special_teams.md) covers this rule.
- **The whole trap is NHL, IIHF and PWHL, and Hockey Canada is a third answer rather than a second.** USA Hockey attaches no substitution restriction to an icing at all (Rule 624). The PWHL writes the NHL's two rules under its own numbers — **84.1** for the substitution ban and **89.1** for the time-out. **Hockey Canada writes one, but only for some categories** — Rule **6.7(d)** applies the *"'no-change on icing' rule"* only *"[i]n categories of U18AAA, Junior, and at the option of the Member in Senior"*, with **6.1(f)** pointing at it in the same terms, and its exceptions and its "when the puck leaves the offending player's stick" test are the NHL's three word for word. **Below those categories an icing costs you the faceoff and nothing else.** ⚠️ **And even where it binds, Hockey Canada leaves you the rest that the NHL and the IIHF take away:** **6.7(d)(iii)** provides that *"[e]ither team is permitted to take their time-out ... following an icing, but during that time out, the team in violation of icing will not be permitted to make player substitutions."* So under that book you may buy the breather; you still may not change the five who have to take the draw.
...
Never: Take contact on the wall with your back to the boards, and never duck — in every league, checking or not
...
2. **Aggressive forecheck.** Switching from a 1-2-2 to a 2-1-2, or to a full-ice press with both defencemen pinching, creates turnovers in their end. (Avoid calling this a "2-2-1" — that's basketball terminology, not an established hockey forecheck name; see [Forechecking Systems](forechecking_systems.md).) Cost: **the second forward is now deep** rather than sitting in the middle band of the zone where a 1-2-2 puts them ([Forechecking Systems](forechecking_systems.md) has both shapes), so a clean exit against you is more dangerous — and if both defencemen are pinching in the full-ice press, so is a fourth body. **F3 stays high in both shapes** — the highest of the three forwards, above the puck, the insurance against the forecheck failing — which is the point of F3; a failed forecheck is far worse when F3 has drifted low ([Forechecking Systems](forechecking_systems.md)).
3. **Pinching defencemen.** A **pinch** is your defenceman stepping down from the *offensive* blue line to keep a puck in — different from a **step up**, which is challenging an opponent forward in the neutral zone. Pinching keeps possession alive; a pinch that misses is a 2-on-1 the other way. Trailing, you pinch on anything close. Leading, you pinch only when you are certain. **Who covers the point behind him is a coaching choice, not a fixed job** — some teams send F3 back to it, some slide the weak-side defenceman across instead, and some run a standing rotation where whoever is highest covers; find out which your team plays. ⚠️ **And a pinch takes the defenceman to the wall, so the receiving posture belongs here too, in every league, checking or not: never take contact with your back to the boards, and never duck.** Skates parallel to the wall, forearm and hip to it, head up and chin off your chest — and not on the point of your shoulder, and not the whole shoulder if you can help it. [Forechecking Systems](forechecking_systems.md#when-to-pinch) sets out the full technique and what your rulebook allows once you arrive — for boarding specifically, the rule that covers a player driven hard into the wall is in [Body Contact and Battles](../technique/body_contact_and_battles.md), §5.
...
- **Down three or more, any time in the third:** the mathematics say be extremely aggressive early rather than moderately aggressive late — one of the clearest findings in the goalie-pull research this document draws on. A team down three with ten minutes left that plays "sensibly" is choosing to lose slowly.
...
The analytics consensus sits much earlier than tradition, and it has been moving that way for years. **Every study this document cites finds the same thing: coaches pull too late** — and Beaudoin and Swartz report that every earlier analysis they review reaches the same conclusion, back to Morrison's 1976 paper, which they call *"the first paper on the subject of pulling the goaltender"*.

**What teams historically did.** Analysis of the 2007-08 NHL season found coaches typically pulled with **1:00 remaining when down one goal and 1:30 when down two** — and essentially never when shorthanded. Across 2003–2013 the league average pull time sat around **1.2–1.3 minutes remaining**, rising to about **1.9 minutes by 2019**. The analyst Meghan Hall puts the average at **1:13 in 2013-14 rising to 1:37 by March 2021**, with a high of **1:46 in 2019-20** — real movement, but slow. Looking only at games with a one-goal deficit, Hall found the average creeping up by about **30 seconds** across seven seasons.
...
- **The empty net is genuinely expensive.** In Beaudoin and Swartz's 2007-08 sample the defending team scored into the empty net every **3.1 minutes** when the road team had pulled its goalie, and every **2.6 minutes** when the home team had — which is, on this document's own arithmetic from their table, roughly **19 to 23 goals per 60 minutes**. This is a real cost, not a rounding error.
- **The trade is still worth it, and worth it earlier.** Simulation over four million games found that simply pulling whenever trailing with under three minutes left was worth about **one extra standings point over an 82-game season**, and a more aggressive policy about **1.5 points** (average points per season 83.7 → 84.7 → 85.2). One study of 2003–2019 pulls found the **highest success rate at a pull around the 3:00 mark, roughly 26% (±4%)** — although the same author cautions that data before about 3:45 is sparse and those estimates are uncertain.
- **A pulled goalie is the biggest lever there is.** Ian Ferer's survival analysis of 2,185 one-goal games (2014-15 to 2018-19) found the leading team was **3.275 times more likely to lose their lead** when the trailing team pulled its goalie.
- **You draw penalties.** In 652.4 minutes of pulled-goalie play in 2007-08, **44 penalties were called on the pulling team versus 84 on their opponents** — close to two against them for every one against you. Penalties came against the defending team every **7.4–7.9 minutes** at 6-on-5, versus every **12.2–13.3 minutes** at 5-on-5.

**And the honest limits.** Success rates are still low, and note what is being measured: Meghan Hall counts a pull as a success when the trailing team **either won in regulation or, far more often, tied the game to force overtime**. On that definition, pulling when down one succeeded roughly **15%** of the time in the most recent seasons of her data; down two, about **1%**, or 25 times in seven seasons; down three, not once. Whatever happens in the overtime that follows is a separate coin-flip on top. And it can go very badly — in their inaugural season the Seattle Kraken allowed **26 empty-net goals while scoring five**.
...
> **Rec-league note:** not every recreational league allows, or practises, pulling the goalie on a delayed call, and some officials will stop play early. **How much rec, beer-league and youth hockey that adds up to is a question about leagues rather than about books, and this document has no count for it.** It also requires your goalie to be paying attention. Talk about it beforehand.
...
Rule: After icing it against a pulled goalie the attacking team picks the dot, you cannot change but for the narrow exceptions and you cannot take a time-out at all — NHL 81.2, 81.4, 87.1, the IIHF the same, and the PWHL at 83.2, 84.1, 89.1; USA Hockey imposes none of the three
...
- **Do not chase.** Six attackers means someone is always open if you leave your area. Play a tight box or diamond in the slot, block lanes, and let them have the perimeter. **⚠️ "Box" and "diamond" are borrowed words, and the count does not come with them.** Both belong to the penalty kill, where [Special Teams](special_teams.md) owns them and both are *four*-player shapes: a **box** is two players high and two low, and a **diamond** is a single apex above two middles and one low — used when their structure has a player in the middle, the **bumper**, whom a box leaves unmarked. Defending a 6-on-5 you have **five** skaters, not four, and this document does not settle where the fifth of them stands. [Defensive Zone Coverage](defensive_zone_coverage.md) names one five-man answer for exactly this situation — the **collapsing box**, all five of you inside the house with sticks in lanes, conceding the entire outside by design — but that is one option and not the shape, so ask your coach before their goaltender comes out. There is no time to work it out once they have pulled him. **And do not reach for Box+1 to fill the gap.** That is a five-man *even-strength* shape from the same document, and its fifth player is the only one who chases the puck — which is the first thing this bullet tells you not to do.
...
Action: In a rec league, treat matching as something you do on the fly — ask whether yours runs a formal change procedure at all; this document has no count of how many do
```
...
> **Rec-league note:** plenty of recreational and beer leagues do not enforce a formal line-change procedure at all, and the referee simply drops the puck — how many is a question about leagues rather than about books, and this document has no count for it. If you're a rec player, treat everything below as something you do *on the fly*, not at stoppages.
...
>
> - **Five shooters a side, not three**, and they must be five *"different shooters"* — where the NHL gives each team *"three shots, unless the outcome is determined earlier"*.
...
- **Make the goalie move first if you can.** Get them sliding, then go where they have just left. [Shooting](../technique/shooting.md) has the shooter's side of this in full.
...
- **Don't commit first.** A goalie who moves before the shooter has decided has handed them a side to go to. Stay square, stay patient, make them decide.
...
Rule: USA Hockey 604(b) bars body checking outright any time a checking team plays a non-checking one — so whether you may check can change per fixture, not just per division
...
Rule: USA Hockey is the outlier: Rule 636(f) gives one sixty-second time-out and attaches no icing condition to it, but “[f]or time curfew games, no time-outs shall be permitted” — and the ask must come before the line change procedure concludes, at any stoppage
...
Key: The measured effect on winning is nil in the NHL study behind this section, and across its 2014-15 to 2019-20 games most benches finished with the time-out still in the pocket
```
...
Rule: The converse — a minor where the puck is outside the paint and you are inside it — is rule text only in the NHL and IIHF (63.6); USA Hockey rules it that way in its Casebook (614 Situation 1); no Hockey Canada rule or Interpretation held here covers it, so price the shot under that book
...
**Now the price, for when you do hold it — and only while your own goaltender is still on the ice.** With your goalie in the net, if the foul actually available to you is holding a puck that is itself in your own crease, a penalty shot (**NHL Rule 67.4**) is still better than the goal it prevented. ⚠️ **With your own net empty there is no such trade.** The identical act is an **awarded goal** rather than a shot under the NHL, the IIHF and Hockey Canada, and under USA Hockey too wherever it prevented an obvious and imminent goal — so holding the puck there concedes the goal you pulled the goalie to chase. How each book reaches that is set out below. **It is the puck's position that decides, not yours, and all four books make the puck's location the test for the shot** — the NHL and the IIHF in **Rule 63.6**, USA Hockey in 614(b) and 618(a), Hockey Canada in **10.2(a)(v) read with 4.11(a)(v)** — because 10.2(a)(v)'s own words locate the *infraction* rather than the puck, and it is 4.11(a)(v), the clause it cross-refers to, that awards the shot where a defending player *"picks up the puck from the ice with their hand while the puck is in the goal crease."* That cross-reference reaches the **hand** limb only, which is the one this section is about; [Defensive Zone Coverage](defensive_zone_coverage.md) sets out how the body limb is located. ⚠️ **The converse is rule text only in the NHL and the IIHF.** Under those two books, gather in a puck lying outside the paint while you stand in it and you have taken a minor, not conceded a shot — Rule 63.6 prints the contrast case in terms. **Neither Hockey Canada nor USA Hockey writes that sentence into its rule text.** Hockey Canada 10.2(a)(v) awards the shot *"when the infraction occurs inside the offending team's goal crease"* and stops there; USA Hockey 614(b) carries no converse clause. ⚠️ **But USA Hockey answers the case one volume over, and it answers it your way.** Its *Casebook*, at **Rule 614, Situation 1**, has a defending player who *"slides and covers the puck with their hand"* while *"[t]he puck is outside the goal crease"*, and whose *"momentum, however, carries them into the goal crease with the puck"*, so that they are in it when play is stopped. Should a penalty shot be awarded? ***"No. The Referee must assess a minor penalty"*** — the Casebook citing 614(a) and 614(b) — because *"[t]he location of the puck at the instant it is covered or held is the determining factor as to whether or not a penalty shot is to be awarded."* ⚠️ **That Casebook ruling is not quite the permutation the NHL writes**, since its player covers the puck outside and slides in rather than standing in the paint and reaching out, **but the reason the book gives is the same one**, and it is the only ruling USA Hockey publishes on the case. **Hockey Canada publishes no ruling on that permutation, in rule text or Interpretation, so price the shot there.** None of this changes the play in front of you: knock the puck straight down where you stand and no book charges you anything.
...
- **Letting your goaltender freeze a routine dump-in when your line is stuck out there.** It is a third route to a trapped bench and the one nobody warns the bench about: the whistle you wanted hands you a defensive-zone draw with the same five tired players still out there. Under **NHL and IIHF Rule 63.8**, a puck shot into your end from the attacking team's own side of the centre red line and then frozen by your goalkeeper bars *your* team from substituting before the draw, at a dot the attacking team chooses. ⚠️ **And that limb's exceptions are two rather than the icing rule's three** — an injured player and a strength-changing penalty, with **no pulled-goalkeeper exception**. Neither USA Hockey nor Hockey Canada writes it (Hockey Canada's 6.1(g) reaches the dislodged net only, in U18 AAA, Junior and Senior at the Member's option).
...
- **Waiting until 1:00 to pull the goalie.** Beaudoin and Swartz report that every earlier analysis they review says this is too late, back to the first paper on the question in 1976, and the gap between practice and the analytics is still substantial.
...
- **Holding a loose puck in your own crease with your own net empty.** Knock the puck straight down where you stand instead — and *straight down*. With a goalie behind you, holding it is a penalty shot, and against a puck that was going in anyway it can be worth taking. With the net empty the NHL, the IIHF and Hockey Canada simply award the goal, and USA Hockey does too wherever the act prevented an obvious and imminent goal. In IIHF Situation 67.6 a defender with his net empty caught the puck and dropped it **outside** the crease, and the ruling was an awarded goal anyway. ⚠️ **And do not read the catch as the whole rule.** NHL and IIHF **67.2(II)** reach a player who places their hand over a puck *"while it is on the ice in order to conceal it from or prevent an opponent from playing the puck"* — no catch at all — and the Note under that clause prices it in your own crease at the penalty shot or the awarded goal. **Neither of the other two books writes a concealment clause**, and neither of them makes the act free: knocking the puck down is the play under all four.
- **Going looking for a hit before finding out whether you may throw one.** Find out first, and where it is barred take the ice rather than the body — the contact is a penalty there before any late-hit question arises. Body checking is barred under USA Hockey **604(a)** at 12 & under and below, in all Girls'/Women's and all non-check Adult classifications, and under Hockey Canada **7.3** at U13 and below, throughout female hockey and in any Member-approved division. ⚠️ **And under USA Hockey 604(b) it is barred for the GAME rather than the division whenever a checking team plays a non-checking one, so reading yourself off the age list is not the whole answer.** The IIHF book names no age, but in women's hockey it allows a bodycheck only *"when there is a clear intention of playing the puck or attempting to 'gain possession' of the puck"*, and subject to the exception the rule itself then sets out (**101.1**).
- **Finishing your check.** Let a player who has already passed or shot go, and take the next puck instead. That hit is a late hit, and no book caps a late hit at a minor — the NHL's **56.4** and the IIHF's **56.5** both reach a major, the IIHF's with a game misconduct and nobody hurt, and USA Hockey's **640(g)** reaches the same tier, with **640(h)** a match above it. USA Hockey's *Declaration of Player Safety* calls the concept *"an unacceptable action"*. See [What a late hit costs in each book](#what-a-late-hit-costs-in-each-book) for the full ladder in all four books.
- **Retaliating.** You turn their penalty into nothing, or their power play into your penalty kill.
- **Firing the puck away after the whistle, and assuming the worst case is two minutes.** Skate away and leave the puck where it is. It is two minutes under the NHL and the IIHF, whose only puck-out-of-play offence is Rule 63.2. **Under the other two books it is a ladder.** USA Hockey prints the same act as a minor at Rule 610(c) **and** a **misconduct** at Rule 601(c)(10) without saying which governs, and Rule 601(d)(7) makes it a **game misconduct** *"when done in protest of an official's decision"* — which is exactly the state of mind you are in when you do it. Hockey Canada could not put an escalation in its delay-of-game rule (10.1(d), *"No Misconduct penalty may be assessed for Delay of Game"*), so it lists *"Shooting the puck out of the playing area, after the whistle"* under **Unsportsmanlike Conduct at Rule 11.1, preamble item (v)**, laddering to a **Game Misconduct at 11.1(e)** that its Note 1 lets a referee reach without the rungs below it.
...
- **Treating the time-out as a momentum spell.** The evidence doesn't support it. Treat it as rest and instruction at a moment of your choosing — and don't end the game with it unused, which is what happened to about 70% of the time-outs available across 2014-15 to 2019-20, a share that rose across those seasons as time-out use fell from 41.8% to 22.8%.
- **Assuming last change means anything in your league.** Plenty of rec leagues don't run a formal change procedure at all, and this document has no count of how many — ask yours. On the road at any level, your matchup tool is the change on the fly.
- **Pinching to keep a puck in with your back to the boards.** Never take that contact with your back to the boards, and never duck: skates parallel to the wall, forearm and hip to it, head up and chin off your chest — not the point of your shoulder, and not the whole shoulder if you can help it. A pinch takes your defenceman down to the wall, and the receiving posture there is not a system choice: it holds in every league, checking or not. [Forechecking Systems](forechecking_systems.md#when-to-pinch) sets out the full technique; [Body Contact and Battles](../technique/body_contact_and_battles.md) §5 owns the boarding rule for a player driven hard into the wall.
...
1. **Trailing teams shoot more; leading teams shoot less.** It is the reason analysts score-adjust shot metrics at all, and it distorts every raw statistic you will ever look at.
...
*Pulling the goalie: [Beaudoin, D. & Swartz, T. B., "Strategies for Pulling the Goalie in Hockey", *The American Statistician*, August 2010, doi:10.1198/tast.2010.09147](https://www.sfu.ca/~tswartz/papers/goalie.pdf) — free author copy hosted by Simon Fraser University, where Swartz is professor of statistics; Beaudoin is at Université Laval. Table 2 and Table 8 read 10 September 2026 · [The State of Goalie Pulling in the NHL — Hockey Graphs](https://hockey-graphs.com/2020/05/18/the-state-of-goalie-pulling-in-the-nhl/) · [When to Pull the Goalie: Running the Numbers on NHL Goalie Pulls — Alex Galea](https://galea.medium.com/when-to-pull-the-goalie-running-the-numbers-on-nhl-goalie-pulls-9fad2a6caceb) · [Here's why the Kraken and other NHL teams are pulling goalies earlier — The Spokesman-Review](https://www.spokesman.com/stories/2022/jun/21/heres-why-the-kraken-and-other-nhl-teams-are-pulli/) · [Ferer, I., "Quantifying the Value of an NHL Timeout using Survival Analysis: Part 1" — Hockey Graphs](https://hockey-graphs.com/2020/05/28/quantifying-the-value-of-an-nhl-timeout-using-survival-analysis-part-1/), the source of the 3.275 figure, also listed below for its time-out findings — all five read 10 September 2026*
...
*Women's professional, read in the local primary text on 23 September 2026: [PWHL Official Rule Book 2025-2026 (PDF)](https://assets.contentstack.io/v3/assets/bltebdb4296e05d53db/bltb8440fe08a5e6dc5/69178cd0a582d7db321ad107/2025-2026_PWHL_Rulebook.pdf) — **Rules 83.2, 84.1 and 89.1**, which impose the attacking team's choice of dot, the post-icing substitution ban and the post-icing time-out ban in the NHL's own words. ⚠️ **The book renumbers from Rule 52 onward**, so the NHL's 81.2, 81.4 and 87.1 will not find them.*
