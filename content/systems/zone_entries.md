...
Rule: 69.4 also reaches the goaltender once he has left the crease to play the puck — an attacker whose deliberate actions prevent his return may be penalised for interference; that it need not be contact is a reading of the rule's structure, not either book's own words (NHL and IIHF)
