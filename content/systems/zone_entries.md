...
- Because it is the **skates** that decide and not the body — and under the NHL and the IIHF's 2026/27 book, only the **blade** — you can be leaning most of your body over the line. Aggressive body position is free.
...
Rule: A defenceman turned to retrieve the puck has his back to you, and that hit is checking from behind — under USA Hockey's Casebook (Rule 608 Situation 1) it is no minor: the major plus game misconduct, or a match penalty, "must be called" for a forceful check on a player standing along the boards
