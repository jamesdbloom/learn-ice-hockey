...
Rule: The trapezoid applies in the NHL, the KHL and under the IIHF book (IIHF Rule 27.7); in Britain the status is unsettled — England Ice Hockey's Rules & Regulations 22.3 say it is "not currently enforced", so assume it binds and ask your league
