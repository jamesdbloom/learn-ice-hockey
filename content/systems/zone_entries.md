...
Rule: Two more books write the same duty — PWHL 85.3(i) carries the NHL's "at the same instant" wording, and CARHA 72(e)(2) asks that every attacker "clear the attacking zone by making skate contact with the blue line" without naming an instant
...
Rule: The goaltender is protected outside the crease too — USA Hockey 607(c) reaches a check or charge "within the goal crease or privileged area" and 607(d) any unnecessary contact, Hockey Canada 8.5(b) makes charging an automatic major plus game misconduct, and CARHA 52(b) and PWHL 42.1 agree
```
