...
6. **The puck carrier should be the last to the line and the support first — waiting at it, onside, not across it.** That ordering is a coaching convention rather than a rule, and arriving with speed is not the same as arriving early.
