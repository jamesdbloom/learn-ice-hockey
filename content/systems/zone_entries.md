...
Rule: Where there is no trapezoid the forecheck still pays — USA Hockey 614(c) bars a goalkeeper freezing the puck outside the "goalkeeper's privileged" area, which excludes the corners, and Hockey Canada's Interpretation 3 to Rule 10.1(a) makes freezing it a minor once he has left the crease
```
...
10. **Angle to take away the retriever's easiest escape rather than to shorten the distance.** Angling is taking the escape away, not arriving through him: a defenceman turned to retrieve has his back to you, and hitting him there is checking from behind. Whether you stand up at your own line, receive the entry, or squash-and-slide is a system your coach chooses, not a law.
