...
Action: Drive the net to the edge of the blue paint, not through it — a skate inside it is what risks the goal
Rule: Keep off the red crease line at the paint's edge too — the Note to USA Hockey 625(b) and Hockey Canada's Glossary count the crease lines as crease, and IIHF Rule 1.7 says the marked line belongs to it; the NHL's and the IIHF's own reference tables both allow a goal on the line
...
Middle drives only work if they are **committed**. A half-hearted middle drive is a player standing in the slot, which frees the defence rather than freezing it. **Committed still stops at the edge of the blue paint**, and off the red line around it — a skate inside the paint is what risks the goal, and the IIHF, USA Hockey and Hockey Canada all count the crease lines themselves as crease — each in a different layer of its book: the IIHF in its rule text, USA Hockey in a Note and in its *Casebook*, Hockey Canada in its Glossary. **No book ranks those layers against each other, which is why off the line is the reading to play.** ⚠️ **Nor is a committed drive licence to hit the goaltender.** Contact you initiate with a goalie who is in his crease voids the goal whether or not it was incidental (**NHL and IIHF Rule 69.3**), and under **USA Hockey 607(c)** a check or charge on a goalkeeper *"within the goal crease or privileged area"* runs from a minor plus a misconduct up to a major plus a game misconduct — an ejection. ⚠️ **Hockey Canada is harsher again and keyed to no area of ice at all:** its **8.5(b)** reads *"A Major penalty and Game Misconduct penalty will be assessed to any player who charges the goaltender"* — an automatic ejection, in the crease or out of it. **And the penalty runs separately from the goal:** **NHL and IIHF 69.2** assess one for intentional or deliberate contact *"whether or not the goalkeeper is inside or outside the goal crease, and whether or not a goal is scored"*. The wide entry above sets out how the four books split on the line itself.
...
**Every drive in every one of them ends in the same place, though** — at the edge of the blue paint, off the red line around it, and short of the goaltender. A triple drive puts three of you into that ice at once, which is exactly when the boundary gets forgotten. **Contact you initiate with a goalie who is in his crease voids the goal whether or not it was incidental** (**NHL and IIHF Rule 69.3**), and under **USA Hockey 607(c)** a check or charge on a goalkeeper *"within the goal crease or privileged area"* can be *"a major plus a game misconduct penalty"* — an ejection. ⚠️ **Hockey Canada is keyed to no area of ice at all:** its **8.5(b)** reads *"A Major penalty and Game Misconduct penalty will be assessed to any player who charges the goaltender"* — an automatic ejection, in the crease or out of it. **And the penalty runs separately from the goal:** **NHL and IIHF 69.2** assess one for intentional or deliberate contact *"whether or not the goalkeeper is inside or outside the goal crease, and whether or not a goal is scored"*. **The wide entry** above sets out where each of the four books puts the crease line.
...
Technique: Skates parallel to the wall, forearm and hip into it — not the point of your shoulder. Head up and chin off your chest
```
...
Technique: Near the wall, skates parallel to the boards, take it on your forearm and hip — not the point of your shoulder. Head up and chin off your chest
...
Technique: Taking it against the boards, skates parallel to the wall, forearm and hip into it — not the point of your shoulder. Head up and chin off your chest
```
...
- **Driving the net *into* the blue paint, or into the goaltender, instead of to the edge of it.** The drive ends at the paint, and at the red line around it: **IIHF Rule 1.7**, USA Hockey's Note to **Rule 625(b)** (and its *Casebook* at **Rule 103, Situation 4**) and **Hockey Canada**'s Glossary all count the crease lines as part of the crease. ⚠️ **The NHL's book says it neither way, and the NHL's and the IIHF's own reference tables both allow the goal** to an attacker planted *"on the crease line"* — **so the IIHF answers the same play in two directions**, and off the line is the reading that holds either way. A skate in there risks the goal under every book, and under USA Hockey it can cost you the zone as well — **625(b)** takes the faceoff out to the neutral zone, though only where your team has possession with the puck in the attacking zone and the goalkeeper is in contact with his crease, and the *Casebook* does not stop play for a stick or skate put there momentarily. ⚠️ **The goaltender is the half of this that is not just a lost goal.** Contact you initiate with a goalie who is in his crease voids the goal, incidental or not (**NHL and IIHF Rule 69.3**); **69.2** assesses a penalty for *"intentional or deliberate contact with a goalkeeper, whether or not the goalkeeper is inside or outside the goal crease, and whether or not a goal is scored"*; and under **USA Hockey 607(c)** a player who *"body checks or charges a goalkeeper while the goalkeeper is within the goal crease or privileged area"* takes *"[a] minor plus a misconduct or a major plus a game misconduct penalty"* — **the upper half of that is an ejection, and Hockey Canada 8.5(b) takes the discretion away entirely** — *"A Major penalty and Game Misconduct penalty will be assessed to any player who charges the goaltender."* [Offensive Zone Play](offensive_zone_play.md) sets out what each one does with an attacker in the crease.
...
7. **The delay runs against instinct, because turning away from the offensive zone feels like retreating.** Alone at the line, turn away, protect the puck, and re-attack a second later with support. **One safety override outranks the play: curl in open ice, not against the wall.** Never take contact with your back to the boards. Near the wall, get your skates parallel to it, forearm and hip, head up and chin off your chest — and not on the point of your shoulder, which USA Hockey rules out in terms ([Body Contact and Battles](../technique/body_contact_and_battles.md), which covers this).
