...
Rule: Hockey Canada puts its heaviest price on the boards version of this hit — 7.5(c) is a Match penalty for a hit from behind "into the boards or goal frame" leaving the player "unable to protect or defend themselves", and 7.5(b) reaches a major plus a game misconduct on the violence alone
