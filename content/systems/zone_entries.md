...
- **Driving the net *into* the blue paint, or into the goaltender, instead of to the edge of it — or arriving there head down.** **Head up, and never meet a post head first or duck into one:** a head-down, head-first hit on a goal post is the same cervical-spine injury as one on the boards, USA Hockey's *Heads Up Hockey* names *"the boards or goal post"* in the same sentence, and it *"can occur at walking speed"* — hit either with an arm or a leg, *"anything but your head first"*. That is every level and every book, not a checking-league point. The drive ends at the paint, and at the red line around it: **IIHF Rule 1.7**, USA Hockey's Note to **Rule 625(b)** (and its *Casebook* at *The Rink*, Situation 4) and **Hockey Canada**'s Glossary all count the crease lines as part of the crease. ⚠️ **The NHL writes no such sentence in its rule text, and the NHL's and the IIHF's own reference tables both allow the goal** to an attacker planted *"on the crease line"* — **so the IIHF answers the same play in two directions**, and off the line is the reading that holds either way. A skate in there risks the goal under every book, and under USA Hockey it can cost you the zone as well — **625(b)** takes the faceoff out to the neutral zone, though only where your team has possession with the puck in the attacking zone and the goalkeeper is in contact with his crease, and the *Casebook* does not stop play for a stick or skate put there momentarily. ⚠️ **The goaltender is the half of this that is not just a lost goal.** Contact you initiate with a goalie who is in his crease voids the goal, incidental or not (**NHL and IIHF Rule 69.3**); **69.2** assesses a penalty for *"intentional or deliberate contact with a goalkeeper, whether or not the goalkeeper is inside or outside the goal crease, and whether or not a goal is scored"*; and under **USA Hockey 607(c)** a player who *"body checks or charges a goalkeeper while the goalkeeper is within the goal crease or privileged area"* takes *"[a] minor plus a misconduct or a major plus a game misconduct penalty"* — **the upper half of that is an ejection, and Hockey Canada 8.5(b) takes the discretion away entirely** — *"A Major penalty and Game Misconduct penalty will be assessed to any player who charges the goaltender."* [Offensive Zone Play](offensive_zone_play.md) sets out what each one does with an attacker in the crease.
...
4. **On a delayed offside, hold at the line — then tag as one: every attacker in the zone puts a skate on the blue line, and the zone is empty before anyone re-enters.** That is the requirement in every book that writes the test. The NHL (83.3(i)), the IIHF (83.3(I)), the PWHL (85.3(i)) and USA Hockey (630(d)(2), the tag-up clause) word it *"at the same instant"*; Hockey Canada (6.11(b)(ii), the tag-up clause) words it as a result, *"completely clear of attacking players"*, and CARHA (72(e)(2)) writes neither. **The wording differs; the requirement does not.** Check your own book for one exception: under USA Hockey Rule 630(d) there is no tag-up at all below Youth 15-Only, Girls 16U, High School and Adult — a restriction Hockey Canada does not impose. **⚠️ And never close on the defending carrier expecting a whistle to arrive first.** Only the NHL, the IIHF and the PWHL stop play because you are *about* to hit him (Rule 83.3; PWHL 85.3); USA Hockey 630(d) and Hockey Canada 6.11(b)(ii) (the stop-play clause) write no contact trigger at all, and USA Hockey's continued-pressure limb is a linesperson's judgement of pressure rather than a warning of an imminent hit. **A defenceman turned to retrieve has his back to you, so hitting him there is checking from behind** — USA Hockey's *Casebook* (Rule 608, Situation 1) requires a major plus a game misconduct, or a match penalty, for a forceful check on a player standing along the boards, and Hockey Canada 7.5 has no cheap tier either — a **game** misconduct rides even its minor (7.5(a), made mandatory by 7.5(e)), and 7.5(b) reaches a **major plus a game misconduct** on the degree of violence of the impact alone. [Delayed offside and tagging up](#delayed-offside-and-tagging-up--three-consequences-for-the-entry) sets those tiers out in full, and [Angle, don't chase](#angle-dont-chase) covers how to arrive on a retriever without becoming that hit.
5. **Attack the space between two defenders rather than at one of them — and go through that seam with your head up.** One defender has an easy job; two sharing a seam have a problem. **The middle seam is also the one route where both can stand you up, so head up is the condition of the drive, not an extra.** IIHF Rule 48.1 opens *"There is no clean check to the head or neck"*, and the sentence written for you is the one immediately before its carve-out: *"When a Player is skating with their head up, whether they are in possession of the puck and may reasonably be expecting impending contact, an opponent does not have the right to hit them to the head or neck."* It holds whether or not you have the puck. **⚠️ Put your head down and you give that away** — the same rule declines to penalise a square check with no upward motion on a puck carrier skating head down **toward the checker**, though a head-down player hit from the side or the blind side sits outside that carve-out, and how far it reaches even inside its own terms is unresolved in the IIHF's own text. **Both halves are the IIHF's own, and the NHL writes neither** — its Rule 48.1 bars an avoidable head hit and stops there, and [Rules Primer](../foundation/rules_primer.md) compares what the other books do instead.
...
11. **Drive to the edge of the blue paint and stop there — clear of the red line around it, short of the goaltender, and head up.** **Never meet a goal post head first, and never duck**: a head-down, head-first hit on a post is the same cervical-spine injury as one on the boards, and it can happen at walking speed. **That is every level and every book, not a checking-league point.** Screening him from outside the crease, without contact, is normally legal and worth doing; it is a skate inside the paint that risks the goal. **IIHF Rule 1.7** has it that *"[t]he marked line belongs to the Goal Crease"*, USA Hockey's Note to **Rule 625(b)** counts the crease lines in, and **Hockey Canada**'s Glossary agrees — but **the NHL writes no such sentence in its rule text, and the NHL's and the IIHF's own reference tables both allow the goal** to an attacker planted *"on the crease line"*. **So the IIHF answers the same play in two directions**, and staying off the line is the reading that holds either way. ⚠️ **Losing the goal is the smaller half of the cost.** Contact you initiate with a goalie who is **in** his crease voids it whether or not it was incidental (**NHL and IIHF Rule 69.3**) — **though that rule signposts its own exception: 69.7 allows the goal where the contact is incidental in a rebound or a scramble for a loose puck. British readers should not plan around that:** the Motorpoint EIHL's *Casebook* addition to the IIHF book writes the test flat, *"Contact in the blue paint area calls for disallowing a goal"*, and its interpretations supersede. **69.2** penalises deliberate contact *"whether or not the goalkeeper is inside or outside the goal crease, and whether or not a goal is scored"*, and the tier reaches an **ejection** in two books — **USA Hockey 607(c)** at its upper end, and **Hockey Canada 8.5(b)** automatically for charging the goaltender. ⚠️ **And the crease is not where **NHL and IIHF Rule 69.4** stops reaching you.** It also penalises an attacker whose *deliberate actions* prevent the goaltender from returning once he has left the crease to play the puck — a foul that does not wait for you to touch him, because the clause turns on intent, not contact. [The middle drive](#the-middle-drive) sets the tiers out in full, and [Offensive Zone Play](offensive_zone_play.md) covers what each book does with an attacker in the crease.
