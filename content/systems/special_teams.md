...
>
> **The five-on-the-clock rules above are yours.** IIHF Rule 84.3 is NHL 84.3 in the same words: a penalty makes it **4-on-3**, coincidental minors with nothing else on the clock continue **3-on-3**, a two-man advantage is played **5-on-3**, the carry-over ladder is identical, and *"at no time will a team have less than three (3) skaters on the ice."*
>
...
- **Against their goalie, know the line.** Screening from **outside** the crease, in the sightline, without contact, is legal and is the single most valuable thing a net-front player does. But the qualifier attaches to the *impairment*, not to where your skates are: Rule 69.1 disallows the goal where an attacker *"either by his positioning or by contact, impairs the goalkeeper's ability to move freely within his crease or defend his goal"* — **positioning alone can do it**. Standing outside the paint is not a safe harbour if you have crowded them out of their own crease. Contact inside the crease that impairs a save is out; incidental contact outside it is fine if you made a reasonable effort to avoid it (Rule 69.4), and a rebound scramble is expressly carved out (NHL and IIHF Rule 69.7 — neither USA Hockey nor Hockey Canada writes a rebound carve-out).
  ...
  **In Britain, the standard is the same but the safety net is gone.** IIHF 69.1 disallows a goal on the same two grounds in the same terms — *"either by their positioning or by a 'relevant contact', impairs the goalkeeper's ability to move freely within their goal crease or defend their goal"* — and the IIHF text then adds that the call *"may be subject to a Video Review… or to a Coach's Challenge."* **The In-House Rules delete both:** *"On-ice video review is not available in EIH or SIHA competition"* (Rule 69.1, and Rule 37 generally), and *"a Coach's Challenge is not permitted"* (Rule 38). So the referee's live judgement of a net-front scramble is the final one, with nothing to appeal it to. If you play net front in England or Scotland, the practical lesson is to give the referee nothing to interpret. See [UK and England Rules](../foundation/uk_rules.md).
