...
**The cheapest improvement available to any team is telling your linemates where they may stand.** If anyone but the two takers moves into the faceoff circle before the puck is dropped, under NHL rules it is your **centre** who is thrown out of the faceoff, not the player who moved. Under the IIHF book — which every level of British hockey is played under — your centre stays and the team spends its one warning for that draw instead, and a second violation on the same draw is a two-minute bench penalty. The standard is word-for-word the same in both: both skates outside the circle, and outside the short hash marks painted beside it, with contact on the line permitted and crossing it not. You may reach with your stick; you may not step.
...
- **A goalie freeze, or any stoppage low in the zone.** Rule 76.2: when the stoppage happens between the end-zone dots and the end of the rink, the draw is at the end-zone dot **on the side where the stoppage occurred**. So which side a goalie freezes the puck on determines which circle you play. Goalies know this.
...
- **A scrum after the whistle that draws the point men in.** If either team's defencemen (or anyone off the bench) come inside the outer edge of the end-zone circle during an altercation, the draw is moved out to the neutral zone (Rule 76.2). This is a real and frequently-conceded cost: your team just turned a won defensive-zone draw into a neutral-zone one, or lost an offensive-zone draw entirely, by joining a shoving match.

**Puck out of play:** the nearest spot in the zone the puck was shot or deflected out from. If it came from the neutral or defending zone, the spot chosen is the one giving the **offending team the least territorial advantage** (Rules 85.1 and 85.5). Two useful exceptions: if the puck leaves the rink **directly off a faceoff**, the draw stays at the same spot and nobody is penalised (Rule 85.1, and the note to Rule 63.2). And a shot that goes into the players' bench through an open door is not a delay-of-game penalty — though note which bench: Rule 85.1 says that if the puck enters the **opposing** team's bench through an open door (or hits an opposing player hanging over it), the draw is in the **neutral zone adjacent to that bench**, not back in the zone the shot came from.
...
Rule: The IIHF book — the one every level of British hockey is played under — matches the NHL word for word at all nine spots (IIHF Rule 76.4)
Rule: USA Hockey reverses this — the attacking player places first everywhere but centre ice (USA Hockey Rule 613(a))
Rule: Hockey Canada differs again — the visiting player places first at every spot, attacking or defending (Hockey Canada Rule 6.2(a) and its Interpretation 1)
...
**The IIHF book agrees with the NHL here, so a British reader can use the two bullets above exactly as written.** IIHF Rule 76.4 carries the same sentence: *"At the eight (8) face-off spots (excluding center ice face-off spot), the defending Player shall place their stick within the designated white area first followed immediately by the attacking Player. When the 'face-off' is conducted at the center ice face-off spot, the visiting Player shall place their stick on the ice first."* This is one of the places where the two books do **not** split — which is worth saying plainly, because the violation *consequences* further down this document are one of the biggest splits between them. Same order of sticks, very different cost when somebody gets it wrong.
...
- **Physical contact with an opponent** before the drop.
...
**One trap if you go and check this in your own book.** The IIHF rulebook states the same lateness carve-out twice, in two different vocabularies. Rule 76.7 uses the IIHF one quoted above; Rule 82.2(VII) uses leftover NHL wording — *"In this situation, the offending team's center is not ejected from the 'face-off'."* That is the **only** appearance of the word "ejected" in the IIHF book's face-off material, and it is a sentence saying an ejection does *not* happen. Do not read it as evidence that IIHF face-off ejections exist somewhere else. They do not: the word appears nowhere in IIHF Rule 76 at all.
...
**Encroachment by a teammate gets the CENTRE ejected, not the teammate.** Two rules work together here, which is why you will see both cited. **Rule 76.6** supplies the consequence: *"If a player other than the player taking the face-off moves into the face-off circle prior to the dropping of the puck, then the offending team's player taking the face-off shall be ejected from the face-off circle. This shall be considered a face-off violation."* **Rule 76.7** then enumerates what counts as encroachment — **(i)** any player other than the centre entering the face-off circle, and **(ii)** any player crossing into the area between the hash marks — and supplies the escalation: *"When a [sic] least two face-off violations have been committed by the same team during the same face-off, this team shall be penalized with a bench minor penalty to the offending team."* The missing word is the rulebook's own — it means *at* least two.
...
Never: Put your hands or your body on the puck in the scrum — tie up the stick and win the puck with your stick
Rule: Winning the draw with your skates is legal in the NHL but a face-off violation under the IIHF book British hockey plays at every level — it burns your team's warning (IIHF Rule 76.3(VI))
```
...
A draw is a closed skill: same start position, same cue, same distance, every single time. That is exactly the kind of thing humans get good at through reps.
...
- **The backhand pull.** Rotate and pull the puck back on the backhand side, usually with the reverse grip. The most common winning technique in hockey, because the pulling motion is stronger and faster than the pushing one.
...
Set plays off draws are the closest hockey gets to American football. They also fail constantly, and the reason is almost always complexity rather than execution.
...
Rule: The IIHF book has no post-icing carve-out and needs none — in Britain the first violation is a warning on every draw (IIHF Rules 76.6, 76.7)
...
**When they iced it:**
- **They cannot change lines** (Rules 81.4 and 82.1), and **they cannot take a timeout** (Rule 87.1). Whoever is on the ice for them, stays on the ice — and they are usually tired, because teams ice the puck when they are pinned. **This one travels to the IIHF book intact** — Rules 81.4 and 87.1 impose both restrictions in the NHL's own words — so it is available to you in British and European league hockey. **USA Hockey imposes neither** (Rule 624 restricts no substitution, Rule 204 gives the normal change windows, Rule 636(f) attaches no icing condition to time-outs), so under that book there is no edge here at all.
- **You can change; they cannot.** The team that iced is frozen — Rule 82.1: *"A team that is in violation of… Rule 81 – Icing shall not be permitted to make any player substitutions prior to the ensuing face-off."* So you get to answer whoever they are stuck with, which is one of the largest matchup edges available to a coach, and it lasts one shift.
  ...
  **And this holds at home as well as on the road.** Rule 82.1's other clause is often quoted short, and quoted short it looks like a problem: the home team may make any desired substitution *"except in cases following an icing"* — whose icing? The full sentence is *"The home team may then make any desired substitution, except in cases following an icing, which does not result in the delay of the game."* That exception is the same bar the rule spells out later — *"A team that is in violation of Rule 63.8 – Delaying the Game or Rule 81 – Icing shall not be permitted to make any player substitutions prior to the ensuing face-off"* — and that Rule 81.4 repeats word for word: it falls on **the team that iced the puck**, not on both benches. So if the visitors ice it, the home team changes normally and keeps last change; if the home team ices it, the home team is frozen and the visitors get the free matchup. See [Special Teams](special_teams.md) for the same point from the special-teams side.
...
Rule: IIHF Rule 81.4 lists a fourth — a player with a broken skate — so in Britain there are four ways off the ice after your own icing
...
Here is the case, plainly. **A faceoff is the only meaningful action in hockey with a fixed starting position, a fixed cue, a fixed distance, and a binary outcome.** Everything else — a shot, a pass, a battle, a gap — happens from a different position every time. Faceoffs are a closed skill in an open-skill sport. Closed skills respond to repetition faster than anything else.
...
- **Practise the technique you're worst at.** Everyone drills their strong-side backhand pull because it feels good. Your weak-side draws are where the points are.
...
- **Teach your wingers the encroachment rule.** Highest return on investment of anything in this document, and it takes thirty seconds.
...
1. Your winger leans a skate over the hash mark before the drop. Who is
   ...
   book every level of British hockey is played under? Then say where a skate
   may legally be. *(§The rule everybody gets wrong)*
...
2. You are taking an end-zone draw. Which centre has to put his stick down
   ...
   routine. *(§Who puts their stick down first)*
...
3. Your centre's best move is kicking the puck back with his skate. Where is
   ...
   centre gets tossed — and where he never is)*
...
1. **A teammate stepping into the faceoff circle before the drop gets your CENTRE thrown out of the draw, not them** — NHL Rule 76.6, USA Hockey Rule 613(d) and Hockey Canada Rule 6.2(a) all eject the centre, in three different forms of words — Hockey Canada's is the plainest: *"the offending team's player taking the face-off will be ejected from the face-off"*. **Three of the four books do.** Both skates outside the circle and outside the hash marks; contact with the line is permitted, crossing it is not. You may reach with your stick; you may not step. Telling your linemates that is the cheapest improvement available to any team.
2. **Under the IIHF book — which every level of British hockey is played under — nobody is ejected from a draw.** A violation is a warning to the team and the puck is dropped again, so you have one free violation per team on every draw rather than only after an icing. Winning the draw with your skates is itself a violation there (IIHF Rule 76.3(VI)), so "kick it back" is not a technique you own.
3. **Two violations by the same team on the same draw is a bench minor under both the NHL and the IIHF books; USA Hockey Rule 613(d) makes it a minor on the individual instead.** And a hand or a body on the puck in the scrum is a minor penalty rather than a faceoff violation **under the NHL and IIHF books** — a **penalty shot** if the puck is inside your own crease (Rules 67.4, 63.6) — while **USA Hockey Rule 618(a) makes the closed hand outside the crease a stoppage and a last-play faceoff rather than a penalty at all**, and a penalty shot or optional minor inside it. Win the draw with your stick. **Catching a puck out of the air and knocking it straight down is legal for everyone else on the ice, but not for the two takers until a third player has touched it** (the note to NHL and IIHF Rule 67.2, printed again at Rule 76.5).
...
6. **Faceoffs are the most improvable skill in hockey**, because they are its only closed skill: same position, same cue, every time. Computed for this document from the NHL's official skater statistics, the 109 centres among the 120 skaters who took at least 500 draws in 2025-26 ran from 62.1% down to 39.7%. That is a single season and a skater-level figure, not comparable with team faceoff percentages.
...
*Rules: [NHL Official Rules 2025-2026 (PDF)](https://media.d3.nhle.com/image/private/t_document/prd/slwjuaqwmuvj5bkplixo.pdf) — Rule 76 Face-offs, Rule 1.5 Lines (blue lines 64 feet from the goal lines), Rule 1.8 Goalkeeper's Restricted Area (trapezoid geometry), Rule 1.9 Face-off Spots and Circles (end-zone dots 20 feet from the goal line; four hash marks per circle, at the outer edge of both sides), Rule 27.8 and Rule 63.2(viii) (the trapezoid penalty and its sole skate-contact exception), Rule 63 Delaying the Game (including 63.2(v) and 63.6, the puck-location test for the penalty shot), Rule 67 Handling Puck (67.2 and its crease note, 67.4 Penalty Shot, 67.5 Awarded Goal), Rule 81 Icing, Rule 82 Line Changes, Rule 83 Off-side, Rule 85 Puck Out of Bounds, Rule 87 Time-outs · [IIHF Official Rule Book 2025/26](https://blob.iihf.com/iihf-media/iihfmvc/media/contentimages/3_the_iihf/2025-26_iihf_rulebook_22122025-v1.pdf) — **the base rule set at every level of British hockey**, and read in full for this document rather than cited from memory. Rule 76.3(VI) for the skate-use violation; Rules 76.4, 76.6 and 76.7 for the warning-instead-of-ejection procedure and the re-drop; Rule 76.7 for the two-violation bench minor, the once-a-game lateness warning and the four-officials clause; Rule 76.2 for the nine spots and the power-play dot choice; Rule 76.5 and Rule 67.2 for hand-play at the draw; Rule 63.2(V) for falling on the puck and Rule 63.6 for the penalty shot that follows when the puck itself is in the crease, in the NHL’s words; Rule 1.8 for the trapezoid and Rule 1.9 for the face-off markings; Rule 81.2 for the attacking team's choice of dot after an icing and the centre-ice draw on an erroneous call; Rule 81.4 for the post-icing line-change ban (**and its fourth exception, a player with a broken skate, which the NHL does not have**); Rule 81.6 for the short-handed icing exemption (**without the NHL's major-penalty carve-out**); Rules 82.1 and 82.2 for last change and the five/eight-second change windows; Rules 83.6, 83.7, 85.1, 85.2 and 85.5 for face-off locations; and Rule 87.1 for the time-out bans, which match the NHL word for word · [IIHF Situation Handbook 2025/26](https://www.iihf.com/en/statichub/6446/rules-and-regulations) — Situations 17.3 and 17.4 (who serves the bench minor for a second face-off violation, including the winger-encroachment-after-warning case) and Situations 76.1–76.11 (face-off locations) · [IHUK In-House Rules 2025-26, Revision 1](https://englandicehockey.com/wp-content/uploads/2025/11/IHUK-In-House-Rules-25-26-R1.pdf) — **searched in full and containing no face-off amendment**; see the verification note below · [USA Hockey Official Playing Rules 2025-29 (PDF)](https://cdn2.sportngin.com/attachments/document/945a-3442848/2025-29_USAH_Playing_Rules.pdf) — Rule 613 Face-Off Procedures, for the reversed stick-down order in 613(a) and the individual minor for a second violation in 613(d), Rule 618(a) Handling Puck with Hands, for the closed hand outside the crease being *"Play shall be stopped and a last play face-off shall occur"* rather than a penalty, and for the penalty shot inside it; Rule 614(b) Falling on Puck, for the same escalation on the body limb and the awarded goal on an empty net; and Rule 624(b)(1), which limits the shorthanded icing exemption to Youth 15-Only and above, Girls 16U and above, High School and Adult · [Hockey Canada Playing Rules 2026-2028 (PDF)](https://cdn.hockeycanada.ca/hockey-canada/Hockey-Programs/Officiating/Downloads/2026-28-hc-rulebook-e.pdf) — Rule 6.2 Face-off Procedure and its Interpretation 1, for the visiting-player-first stick order at every spot and the warning-then-minor enforcement of it. Hockey Canada was read for the stick-placement order only; the rest of this document has not been compared against that book*
