...
- **Putting a hand or your body on the puck in the scrum.** An open hand over the puck is a minor (Rule 67.2(ii)) and so is falling on it or gathering it into your body (Rule 63.2(v)). Tie up the stick and win it with your stick instead — **not your skates**, which is legal in the NHL but a face-off violation under the IIHF book British hockey plays at every level (IIHF Rule 76.3(VI)), and it spends your team's one warning.
...
3. **Two violations by the same team on the same draw is a bench minor under both the NHL and the IIHF books; USA Hockey Rule 613(d) makes it a minor on the individual instead.** And a hand or a body on the puck in the scrum is a minor penalty, not a faceoff violation — win the draw with your stick.
