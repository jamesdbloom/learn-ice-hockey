...
A **faceoff** (also called a **draw**) is how play starts and restarts: an official drops the puck between the sticks of two opposing players, and whoever wins it gives their team possession. There are roughly **56 of them in an average NHL game** — 56.6 per game in 2024-25 and 56.0 in 2025-26, computed from the NHL's official statistics. That is 56 guaranteed, scheduled, whistle-stopped possession opportunities where you know exactly where the puck will be, exactly when, and exactly where all ten skaters are standing.

Nothing else in hockey is that predictable. That is what makes faceoffs the most practisable part of the game, and it is why they are also the most neglected: they look like a coin flip, so people treat them like one.

This document is the deep dive. It covers what the research actually says about how much draws matter, where the nine faceoff spots are and what sends the puck to each one, the exact procedure and violation rules, the techniques for winning a draw, and the full five-player alignments and set plays that the position documents can only gesture at.
...
*(The dimensions in that table are the rink's, and [Rink Map and Glossary](../foundation/rink_map_and_glossary.md) owns them — it carries the same figures alongside the rest of the ice, with the IIHF metric equivalents.)*
...
- **Putting a hand or your body on the puck in the scrum.** An open hand over the puck is a minor (Rule 67.2(ii)) and so is falling on it or gathering it into your body (Rule 63.2(v)). Tie up the stick and win it with your stick or skates instead.
...
1. There are about **56 faceoffs a game** and most of them barely matter — faceoff percentage explains only around 6% of the variation in team **points percentage** across eleven NHL seasons. Ten to fifteen a game matter enormously. Say the honest version, then spend your attention on the situational draws.
2. **Know all nine spots, and know what sends the draw to each.** Knowing where the next draw will be lets you be there first — and under **NHL and IIHF** rules, after an icing or at the start of a power play, **you get to choose the dot** — choose your centre's strong side. **USA Hockey gives no dot choice in either case** (Rules 624(a), 612(b)), so find out which book you are in.
3. **At eight of the nine spots the defending player puts their stick down first under NHL rules — and the attacking player under USA Hockey rules**; only at centre ice, in both books, does the visitor go first. Going second means seeing the other blade angle before you show yours, so **the advantage of going second belongs to the attacking team in the NHL and to the defending team under USA Hockey** — it is exactly reversed (NHL Rule 76.4; USA Hockey Rule 613(a)). Work out which book you are in before you build a habit on it. And the attacking team's other four skaters must set their positions before the defending team counters.
4. **A winger's encroachment ejects the CENTRE** under NHL rules, and **costs your team its one warning** under the IIHF rules Britain plays by (see 6). Both skates outside the circle and outside the hash marks; touching the line is legal, crossing it is not — the positioning standard is word-for-word the same in both books. Tell your linemates — it is the cheapest improvement available to any team.
5. **Two violations by the same team on the same draw is a bench minor** — under USA Hockey Rule 613(d) it is instead a minor on the individual who committed the second violation — so the replacement taker plays it simple. And a hand or a body on the puck in the scrum is a **minor penalty**, not a faceoff violation — win it with your stick or your skates.
6. **Under IIHF rules there is no ejection** — a violation is a warning to the team and the draw is taken again, and winning a draw with your skates is itself a violation. **That is the rulebook every level of British hockey is played under**, so for a UK reader this replaces the ejection rules above rather than qualifying them: nobody is thrown out of a draw, you get one free violation on every draw rather than only after an icing, and "kick it back" is not a technique you own. See [UK and England Rules](../foundation/uk_rules.md). Know which rulebook you're under.
7. **Watch the linesperson's hand, not your opponent.** You are training a reaction, not a duel.
8. **Your handedness decides your strong circle.** Your strong side is the one where your natural backward pull sends the puck toward the boards. On the weak side, either learn the forehand pull, flip your hands, or let the other centre take it.
9. **Every alignment needs a plan for the win, the loss AND the tie-up** — and the tie-up is the most likely of the three. Most faceoff goals against are four players not knowing what to do next.
10. **Faceoffs are the most improvable skill in hockey** because they are the only closed skill in it: same position, same cue, every time. Among NHL centres taking at least 500 draws in 2025-26 the range ran from 62.1% down to 39.7% — a 22-point spread, and nothing that wide is luck. On the power play in particular, the entry you avoid by keeping the zone is worth more than any set play off the draw.

---

*Sources — retrieved 27 July 2026:*

*Rules: [NHL Official Rules 2025-2026 (PDF)](https://media.d3.nhle.com/image/private/t_document/prd/slwjuaqwmuvj5bkplixo.pdf) — Rule 76 Face-offs, Rule 1.5 Lines (blue lines 64 feet from the goal lines), Rule 1.8 Goalkeeper's Restricted Area (trapezoid geometry), Rule 1.9 Face-off Spots and Circles (end-zone dots 20 feet from the goal line; four hash marks per circle, at the outer edge of both sides), Rule 27.8 and Rule 63.2(viii) (the trapezoid penalty and its sole skate-contact exception), Rule 63 Delaying the Game, Rule 67 Handling Puck, Rule 81 Icing, Rule 82 Line Changes, Rule 83 Off-side, Rule 85 Puck Out of Bounds, Rule 87 Time-outs · [IIHF Official Rule Book 2025/26](https://blob.iihf.com/iihf-media/iihfmvc/media/contentimages/4_sport/officiating/rule_book/25_26/2025-26_iihf_rulebook_19052025-v1.pdf) — **the base rule set at every level of British hockey**, and read in full for this document rather than cited from memory. Rule 76.3(VI) for the skate-use violation; Rules 76.4, 76.6 and 76.7 for the warning-instead-of-ejection procedure and the re-drop; Rule 76.7 for the two-violation bench minor, the once-a-game lateness warning and the four-officials clause; Rule 76.2 for the nine spots and the power-play dot choice; Rule 76.5 and Rule 67.2 for hand-play at the draw; Rule 63.2(V) for falling on the puck; Rule 1.8 for the trapezoid and Rule 1.9 for the face-off markings; Rule 81.2 for the attacking team's choice of dot after an icing and the centre-ice draw on an erroneous call; Rule 81.4 for the post-icing line-change ban (**and its fourth exception, a player with a broken skate, which the NHL does not have**); Rule 81.6 for the short-handed icing exemption (**without the NHL's major-penalty carve-out**); Rules 82.1 and 82.2 for last change and the five/eight-second change windows; Rules 83.6, 83.7, 85.1, 85.2 and 85.5 for face-off locations; and Rule 87.1 for the time-out bans, which match the NHL word for word · [IIHF Situation Handbook 2025/26](https://www.iihf.com/en/statichub/6446/rules-and-regulations) — Situations 17.3 and 17.4 (who serves the bench minor for a second face-off violation, including the winger-encroachment-after-warning case) and Situations 76.1–76.11 (face-off locations) · [IHUK In-House Rules 2025-26, Revision 1](https://englandicehockey.com/wp-content/uploads/2025/11/IHUK-In-House-Rules-25-26-R1.pdf) — **searched in full and containing no face-off amendment**; see the verification note below · [USA Hockey Official Playing Rules 2025-29 (PDF)](https://cdn2.sportngin.com/attachments/document/945a-3442848/2025-29_USAH_Playing_Rules.pdf) — Rule 613 Face-Off Procedures, for the reversed stick-down order in 613(a) and the individual minor for a second violation in 613(d), and Rule 624(b)(1), which limits the shorthanded icing exemption to Youth 15-Only and above, Girls 16U and above, High School and Adult*
