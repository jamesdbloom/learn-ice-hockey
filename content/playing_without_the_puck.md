...
- **The 2002 possession figures are now sourced to the primary, and the previous note here was wrong on three counts.** It said the numbers came from "an earlier study" summarised by the LINHAC paper as its reference [13], that the original could not be retrieved, and that Mike Modano and Joe Sakic averaged 1:07. In fact: reference [13] is **Harry Thompson, "The Power of Practice"**, a *USA Hockey Magazine* feature — not a study, and Thompson tracked nothing. He is reporting **USA Hockey's own 2002 puck-possession study** of the Olympic Winter Games and the Youth Tier I National Championships, whose data tables are printed at pp. v–vi of USA Hockey's [*Small Area Competitive Games*](https://cdn1.sportngin.com/attachments/document/38c0-3079160/USA_Hockey_Small_Area_Competitive_Games.pdf) handbook — **a document this corpus already cites, with a live link, in** [Practice and Development](practice_and_development.md). So the original was retrievable all along; it has now been retrieved and read, and the figures above are taken from it directly. Two consequences: **1:07.05 is the men's per-game tournament average, not a Modano or Sakic figure** (the player names come from Thompson's magazine gloss), and **1:06.02 is the 14-and-Under bracket alone**, not youth nationals generally. The chain was LINHAC → Thompson → USA Hockey, and only the last link measured anything.
