...
*"On-ice video review is not available in EIH or SIHA competition."* The In-House Rules repeat that exact sentence against **nine** separate provisions — double minor penalties (18.4), the official scorer (33.2), the game timekeeper (34.7), the penalty timekeeper (35.8), Rule 37 itself, high-sticking (60.3), goaltender interference (69.1), goals (78.5) and puck out of bounds (85.7) — and add a tenth at 78.6 in slightly different words (*"Video review is not in use in EIH or SIHA competition"*).
...
In women's hockey, **Adult runs from the player's 14th birthday** and Under 16 from the 10th to the 16th. Below adult, any foul carrying a major penalty *"will, in all cases, also receive an additional Game Misconduct Penalty."*
...
- **Thinking a major in junior hockey costs you five minutes.** In women's hockey below Adult it ends your game outright, and In-House Rule 201 reads as extending the same consequence across junior hockey U19 to U10 — plan for the ejection and confirm with your league. **And do not read that as adults being safe.** IIHF 20.4 adds an automatic game misconduct *"whenever a Player is assessed a major penalty for any of the infractions listed in the Reference Tables"* — the NHL's 20.4 says the same of its Table 5, though its individual rules then split — seven unconditional, six requiring an injury — and the IIHF's Table 6 lists twenty, unconditionally — three of them fighting entries, so the like-for-like pair is seventeen against thirteen — checking from behind, cross-checking, slashing, hooking, high-sticking, slew-footing, clipping and an illegal check to the head among them. **Table 7 adds five more where the game misconduct is the referee's judgement rather than automatic — boarding 41.4, charging 42.4, elbowing 45.4, interference 56.5 and tripping 57.4**, so your first-major exposure is wider than Table 6 alone — though on those five it is the referee's call, and **41.3 lets a boarding major stand with no game misconduct at all**. **At adult level a first major for any of the Table 6 twenty ends your game**; what the junior and women's rules add is that *any* major does.
...
7. **Play junior hockey as though any major penalty is an automatic ejection, from U19 down to U10** — and do not read that as adults being safe: IIHF 20.4 ejects an adult on a *first* major for any of the twenty infractions in Reference Table 6 — three of them fighting entries, so seventeen others — and it does so unconditionally, where the NHL's nineteen rows split thirteen non-fighting and six fighting-related, and require an injury for six of the thirteen — **and Table 7 adds five more where the game misconduct is the referee's judgement rather than automatic — boarding 41.4, charging 42.4, elbowing 45.4, interference 56.5 and tripping 57.4**. **On first-major ejection, yours is the stricter book.** The IIHF book writes no match penalty at all — not for boarding, not for high-sticking, not for an illegal check to the head, and not for anything else, because that penalty does not exist in the book. **Do not read that as leniency:** high-sticking 60.4 and an illegal check to the head 48.3 are both Reference Table 6 entries, so a first major for either ejects you automatically. In-House Rule 201 scopes the IIHF junior playing rules to all junior age groups without naming Rule 201.1, so that extension is an inference rather than the rule's own words — but it is the conservative one, and confirming it with your league costs nothing. In **women's** hockey below adult the cross-reference is explicit (Rule 101), so there it is not an inference. Junior categories are British, unisex and set by birth year.
...
*Rules: [IHUK In-House Rules 2025-26, Revision 1 (published 27/10/25)](https://englandicehockey.com/wp-content/uploads/2025/11/IHUK-In-House-Rules-25-26-R1.pdf) — the source for every amendment quoted above · [IIHF Official Rule Book 2025/26](https://blob.iihf.com/iihf-media/iihfmvc/media/contentimages/4_sport/officiating/rule_book/25_26/2025-26_iihf_rulebook_19052025-v1.pdf) — the foundation the In-House Rules amend · [England Ice Hockey Rules & Regulations 2024-2025](https://englandicehockey.com/wp-content/uploads/2024/09/1.0-5.0-EIH-Rules-and-Regulations.pdf) — governance, registration and club administration rather than playing rules*
