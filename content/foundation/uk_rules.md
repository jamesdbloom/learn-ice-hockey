...
*"On-ice video review is not available in EIH or SIHA competition."* The In-House Rules then repeat that bar in **nine** further provisions, spread across **eight** other rules: double minor penalties (18.4), the official scorer (33.2), the game timekeeper (34.7), the penalty timekeeper (35.8), high-sticking (60.3), goaltender interference (69.1), goals (78.5 **and** 78.6) and puck out of bounds (85.7). Eight of the nine use Rule 37's sentence word for word; **78.6** alone words it differently — *"Video review is not in use in EIH or SIHA competition."*
...
12. A teammate goes down and is not getting up. In England or Wales, what is
