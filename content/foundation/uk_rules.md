...
*"On-ice video review is not available in EIH or SIHA competition."* The In-House Rules say this against four separate IIHF rules — high-sticking (60.3), goaltender interference (69.1), goals (78.5 and 78.6) and puck out of bounds (85.7).
...
IIHF Rule 1.2 specifies a sheet *"60m long and 26m to 30m wide"* — note that 30 m is the top of a range, not the standard. In England and Scotland, *"rinks with a non-standard playing surface (below 56 m × 26 m) are authorised by the NGB for all levels of hockey"*, with two named exceptions permitted only up to U16 — Sutton in England, and Coatbridge and Limekilns Road in Scotland.
...
Benches must carry a **Level 2 or higher non-playing coach aged 18+**, plus one more coach at minimum Level 1. A team manager and medic may sit on the bench but do not count toward that requirement.
...
- **Assuming neck protection is optional because you are an adult.** That is the North American position, and it is not the British one. It is a 10-minute misconduct, with no warning.
- **Expecting a review.** There is no on-ice video review in EIH or SIHA competition.
- **Assuming your rink is 60 × 30.** Most British rinks are not, and many are below 56 × 26.
...
6. **Your rink is probably smaller than the book's** — below 56 m × 26 m is authorised, which is under the IIHF minimum on both length and width.
7. **In women's hockey a half visor is permitted only from the season after your 18th birthday** — a relaxation of the IIHF's full-face requirement, not a rule for everyone. A half visor is the minimum in SIHA recreational and university hockey.
8. **Junior categories are British and unisex**, set by birth year, and are not classified as "Mens".
9. **Overtime is not universal** — only NIHL, and SNL where its regulations provide for it.
