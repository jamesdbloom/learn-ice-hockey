...
One or two sentences each. Terms in **bold** inside a definition are defined elsewhere in this list.
...
**Backcheck** — racing back toward your own end to defend after your team loses the puck. *Not the same as* **forecheck**, which is pressure applied in the opponent's end.

**Backdoor** — the **weak-side** net-front area. A backdoor pass goes cross-ice to a player arriving there unmarked, behind the goaltender's line of sight.
...
**Empty net** — the net with the goaltender pulled for an extra attacker, usually late when trailing. A shot from your own end at an empty net still counts as a goal, so **icing** does not apply to it.
...
**Forecheck** — pressure applied to the opposing team in *their* defensive zone, to force a turnover before they can break out. *Not the same as* **backcheck**. Named by shape: 2-1-2, 1-2-2, 1-3-1, 1-4.
...
7. **The trapezoid is 22 ft along the goal line widening to 28 ft at the boards** (IIHF: 6.80 m to 8.60 m), applies in the NHL, KHL and IIHF, and does not exist in most *North American* rec leagues. **In England it is the IIHF rule but England Ice Hockey's Rule 22.3 says it is "not currently enforced"** — and the current In-House Rules are silent, so check locally rather than assuming. Its one exception is a goalie keeping skate contact with the crease.
