...
>
> **Related:** [Game Management](game_management.md) · [Scanning and Anticipation](scanning_and_anticipation.md) · [Mental Game](mental_game.md) · [Time and Space](time_and_space.md) · [Puck Support and Spacing](puck_support_and_spacing.md) · [Breakouts](breakouts.md) · [Zone Entries](zone_entries.md) · [Defensive Zone Coverage](defensive_zone_coverage.md) · [Rink Map and Glossary](rink_map_and_glossary.md)
...
Public tracking work has actually put numbers on the upside of different puck decisions. Thibaud Chatel's "Hockey Decision Tree" work at Hockey Graphs (March 2020), built from roughly **11,000 manually tracked possession sequences** in France's Ligue Magnus and Switzerland's NLA over three seasons, valued each type of play as *how often it leads to a shot attempt* multiplied by *the average expected goals of the sequences it appears in*.
...
6. **Never at any point in this list:** turn back into the middle of the ice at your own blue line, or make an east–west pass across centre ice. Those two plays generate more 2-on-1s against than anything else in hockey.
...
**In the 2025-26 NHL regular season, teams scored 1,595 power-play goals on 7,555 opportunities — a league-wide conversion rate of 21.1%** (aggregated across all 32 clubs for this document from the NHL's public team power-play report; see Sources). Teams on the power play also conceded 205 shorthanded goals, about 2.7% of opportunities. So the honest arithmetic:
...
- **Stopping play when you are pinned and exhausted with no change available.** Cynical, effective, and universally disliked. It is a real tactical option and it is also a good way to lose your teammates' goodwill — see [Team Play and Culture](team_play_and_culture.md).
...
Two riders in the same rule are worth knowing. If you play the **puck first** and trip the opponent in the process, it is a minor for tripping and not a penalty shot. And if the attacker has already beaten the goalie and is fouled with the open net in front of him, it is *still* only a penalty shot, because — in the rulebook's words — *"no goal can be awarded since the goalkeeper is still on the ice."*
...
*Not verified: the relative risk ordering of areas of the ice, and the characterisation of most amateur penalties as frustration or laziness, reflect coaching consensus rather than published measurement, and are flagged as such in the text.*
