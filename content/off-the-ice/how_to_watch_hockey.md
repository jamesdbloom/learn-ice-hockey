...
- **Whether they ever stop moving.** Amateur players are often said to glide for around a third of their shift — a coaching observation, not a measurement. **Do not assume professionals do not.** The one published count of gliding puts **two-foot glide first among NHL forwards' skating characteristics, at 39% of their total time on the ice** ([Skating](../technique/skating.md) carries the study, its sample and its limits; the figure is read from Bracko's own restatement of those tables — "Biomechanics powers ice hockey performance", *Biomechanics*, September 2004, page 47, where it appears without a decimal in both the prose and the table — because the 1998 paper the tables come from is paywalled). That is a *balance position*, not a rest: Bracko records the gliding position as rarely sustained, interspersed with strides and turns, and every other characteristic both starts from it and returns to it. So the thing to watch is not whether a player glides. It is whether the glide is taking them somewhere.
