...
There are around **56 faceoffs in an average NHL game** — [Faceoffs](../systems/faceoffs.md) owns that figure and the computation behind it — so this happens constantly. Look at the four non-centres on each team before the puck drops.
