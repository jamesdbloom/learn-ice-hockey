...
- A tired player reaches with the stick instead of moving the feet, which is how tripping and hooking penalties happen.
...
**Resistance training for youth is not inherently dangerous — that is the settled position in youth strength-and-conditioning practice.** Supervised, well-coached, technique-focused strength training is generally regarded as safe and beneficial for young athletes, and the risk lies in poor supervision and inappropriate loading rather than in the concept. **No source is cited for that here and none was found, so treat it as the field's consensus rather than as a measured finding, and act on the sentence that follows.** **Get qualified coaching.**
...
11. **Conditioning is a decision-making asset:** your judgement fails before your legs, so change before you need to, not when you need to. **For youth, variety beats specialisation** — no single sport before about age 12, weekly training hours below the athlete's age in years; consensus guidance, not tested thresholds.
...
*Shifts per game (primary data): [NHL public stats API — skater time-on-ice report](https://api.nhle.com/stats/rest/en/skater/timeonice?cayenneExp=seasonId=20242025%20and%20gameTypeId=2), 2024-25 regular season; the `shiftsPerGame` and `timeOnIcePerShift` fields, aggregated here over the 587 skaters with 41 or more games played*
...
- ***Resistance training for youth.*** *The statement that supervised, technique-focused youth resistance training is safe and beneficial is the settled position in youth strength-and-conditioning practice, but **no source is cited for it here and none was found** among the sources this document draws on — the youth-section citations cover early specialisation, career outcomes and injury physiology rather than resistance-training safety. It is labelled inline as the field's consensus rather than a measured finding.*
