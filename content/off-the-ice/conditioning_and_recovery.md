...
**What it buys you:** a harder push, a faster start, more stability on your edges, and more mass behind you in a puck battle. See [Body Contact and Battles](../technique/body_contact_and_battles.md) for what you do with it.
...
**What it buys you:** shot power comes from the ground up through a rotating trunk, not from the arms (see [Shooting](../technique/shooting.md)); and every board battle is a test of whether your midsection can transmit force from your legs to your opponent without folding.
...
**How common it is.** In a 2025 *American Journal of Sports Medicine* study of NHL goaltenders, **proximal adductor injuries accounted for the largest number of injuries (n = 371) and the highest total days missed (6,126)** — more than any other injury category. Goaltenders are an extreme case because of the butterfly position (see [Goaltender](../positions/goaltender.md)), but the pattern holds across positions.
...
> **Rule-set flag that genuinely changes your risk:** body checking is legal in NHL and most senior men's play; it is prohibited in most youth age groups below U13/U15 depending on association, and in most adult recreational and beer leagues. 🇬🇧 **Those age lines are North American and do not transfer to Britain.** Neither the IIHF book nor the In-House Rules set an age at which body checking becomes legal — the answer sits in your competition's regulations, so ask your league rather than assuming USA Hockey's 12U line or Hockey Canada's U13 is yours ([UK and England Rules](../foundation/uk_rules.md)). Note too that under In-House Rule 100.1 the women's **Adult** category starts at the player's **14th birthday**, so the IIHF women's rule below binds British players younger than a North American reader would expect. **Women's hockey divides by book, and two of the four make it blanket.** USA Hockey Rule 604(a) prohibits body checking in *"all Girls'/Women's age classifications"* and Hockey Canada Rule 7.3(a) throughout *"female hockey"* — at every age, with no playing-the-puck permission to read into either: a minor at the floor (USA Hockey 604(c), Hockey Canada 7.3(a)), a major plus a game misconduct above it (604(d), 7.3(b), the latter mandatory *"[i]f a player is injured"*), and a match penalty above that (604(e), 7.3(c)). **Under the IIHF book — which is what women's hockey in Britain plays — it is not a blanket prohibition, but the permission is a restricted one, so read the whole sentence.** IIHF Rule 101.1 provides that *"in Women's Hockey 'bodychecking' is allowed when there is a clear intention of playing the puck or attempting to 'gain possession' of the puck **with the exception from the situation described in this rule**"* — and the exceptions it then describes do not turn on what you were trying to do. **Stepping or gliding into an opponent is at least a minor however clearly you were playing the puck:** *"Any move by a Player to step or glide into an opposing Player will be assessed at least a minor penalty (2') for an 'illegal hit'."* Using the boards to eliminate an opponent, push her into them or pin her along them is barred **even where** *"'possession of the puck' remains the sole object of the two (2) Players"*. And a stationary player is protected outright: *"It is up to the opponent to avoid body contact with such a Player."* An illegal hit runs to a minor (2') **or a major (5') plus an automatic game misconduct**. [Body Contact and Battles](../technique/body_contact_and_battles.md) sets the rule out in full, clause by clause. **Know which you are playing.** The physical preparation and the risk profile are different.
...
- **Give your goalie proper shots.** Not the top corner from the slot on the first shot. Start with easy shots from distance and work in. Your goalie is warming up too, and they are the one player who cannot ease into the game. See [Goaltender](../positions/goaltender.md).
...
2. **You are already tired.** You have worked all day. Accept that your ceiling is lower and manage shift length accordingly — see [Game Management](../systems/game_management.md).
...
- A tired player stops scanning, because scanning costs attention and attention is expensive when you are gassed (see [Scanning and Anticipation](../hockey-iq/scanning_and_anticipation.md)).
...
**This is why conditioning is a hockey IQ issue and not just a fitness issue.** [Game Management](../systems/game_management.md) covers the tactical side — short shifts, changing on the right side of the puck, when a long shift is unavoidable and how to survive one. The physical side is this: **the fitter you are, the longer your judgement lasts, and judgement is what you are actually paid in.**
...
- **Adductor work** — Copenhagen adduction or a regressed version (short-lever, knee-supported), plus a squeeze isometric. Start very conservatively; this exercise makes people extremely sore if they dive in. **No exercise on this list is a guarantee against a groin strain, and the evidence for this one is thinner than its reputation** — the review its strength numbers came from has since been retracted; see [Groin and adductor strain](#groin-and-adductor-strain--the-classic-hockey-injury).
- **Anti-rotation core** — Pallof press or a loaded carry. 3 sets.

**Session 2 — Conditioning (30 minutes)**
...
7. You have ten minutes before you get dressed and you have never warmed up off
   the ice. What is the best-evidenced thing you can do with them — and what
...
5. **Your adductors are probably weak relative to your abductors, and in professional ice hockey players that was a measured risk factor** — below 80% of abductor strength, 17 times more likely to strain an adductor. Strengthen them deliberately, but no single exercise is proven to prevent it: the pooled Copenhagen evidence was rated **very low certainty** in a review that has since been **retracted**, leaving the strength claim unsupported for ice hockey specifically.
...
*Rules: [IIHF Official Rule Book 2025/26 (PDF)](https://blob.iihf.com/iihf-media/iihfmvc/media/contentimages/3_the_iihf/2025-26_iihf_rulebook_22122025-v1.pdf) — **Rule 101.1**, in the book's `RULE 101 WOMEN'S HOCKEY – SPECIFIC PLAYING RULES` section and so scoped to women's hockey, providing that *"in Women's Hockey 'bodychecking' is allowed when there is a clear intention of playing the puck or attempting to 'gain possession' of the puck with the exception from the situation described in this rule"*, and going on to make *"any move by a Player to step or glide into an opposing Player"* at least a minor, to bar using the boards to eliminate, push in or pin an opponent even where possession *"remains the sole object of the two (2) Players"*, and to protect the stationary player — *"It is up to the opponent to avoid body contact with such a Player"* — with the penalty running to a major (5') plus an automatic game misconduct. · [IHUK In-House Rules 2026-27, Revision 1 (published 25 July 2026)](https://englandicehockey.com/wp-content/uploads/2026/08/IHUK-In-House-Rules-2026-2027.pdf) — **the current British document**, read 31 August 2026: **Rule 100.1 Definition of Women's Hockey Age Categories**, whose *"Adult: From the player's 14th birthday onward"* is what makes the IIHF women's rule bind British players younger than a North American reader expects, and which is unchanged from the 2025-26 edition. Its Introduction adopts the IIHF book *"in England, Wales, Scotland and Northern Ireland (the Home Countries)"*, where the superseded [2025-26 edition](https://englandicehockey.com/wp-content/uploads/2025/11/IHUK-In-House-Rules-25-26-R1.pdf) reached England and Scotland only. Searched flattened, both editions: neither names an age at which body checking becomes legal. The IIHF book and the current In-House Rules are both cited at §Concussion risk and body checking.*

*Hockey physiology and match demands: [Vigh-Larsen JF, Mohr M — "The physiology of ice hockey performance: An update", Scand J Med Sci Sports, 2024 (PMID 36517860)](https://europepmc.org/article/MED/36517860) · [Gabrys T et al. — "Energy Structure of Repeated On-Ice Efforts and Its Dependence on the Aerobic Capacity of a Hockey Player", Sports, 2026 (PMID 41893607)](https://europepmc.org/article/MED/41893607) · [Lögdal N, Laaksonen MS, Andersson EP — "Individual Fluctuations in Blood Lactate During Ice Hockey", Int J Exerc Sci, 2022 (PMID 36159342)](https://europepmc.org/article/MED/36159342) · [Rago V et al. — "Game Demands of a Professional Ice Hockey Team", J Hum Kinet, 2022 (PMID 36457463)](https://europepmc.org/article/MED/36457463) · [Lignell E, Fransson D, Krustrup P & Mohr M — "Analysis of High-Intensity Skating in Top-Class Ice Hockey Match-Play in Relation to Training Status and Muscle Damage", J Strength Cond Res 32(5):1303–1310, 2018 (PMID 28557852)](https://pubmed.ncbi.nlm.nih.gov/28557852/) — the source for the forwards-versus-defencemen distance and intensity split above; abstract retrieved and quoted directly, 27 July 2026*

*Phosphocreatine resynthesis and oxygen: [Haseler LJ, Hogan MC, Richardson RS — "Skeletal muscle phosphocreatine recovery in exercise-trained humans is dependent on O2 availability", J Appl Physiol, 1999;86(6):2013–18 (PMID 10368368)](https://pubmed.ncbi.nlm.nih.gov/10368368/) · [Harris RC, Edwards RHT, Hultman E, Nordesjö LO, Nylind B, Sahlin K — "The time course of phosphorylcreatine resynthesis during recovery of the quadriceps muscle in man", Pflügers Arch, 1976;367(2):137–42 (PMID 1034909)](https://pubmed.ncbi.nlm.nih.gov/1034909/) · [Tomlin DL, Wenger HA — "The relationship between aerobic fitness and recovery from high intensity intermittent exercise", Sports Med, 2001;31(1):1–11 (PMID 11219498)](https://pubmed.ncbi.nlm.nih.gov/11219498/)*

*Shifts per game (primary data): [NHL public stats API — skater time-on-ice report](https://api.nhle.com/stats/rest/en/skater/timeonice?cayenneExp=seasonId=20242025%20and%20gameTypeId=2), 2024-25 regular season; the `shiftsPerGame` and `timeOnIcePerShift` fields, aggregated here over the 597 skaters with 41 or more games played; report re-read and every figure below recomputed from it on **2 September 2026***

*Off-ice training and transfer to skating: [Keiner M et al., J Strength Cond Res, 2024 (PMID 38335067)](https://europepmc.org/article/MED/38335067) · [Glaude-Roy J et al., Eur J Sport Sci, 2024 (PMID 39256936)](https://europepmc.org/article/MED/39256936) · [Roczniok R et al., J Hum Kinet, 2024 (PMID 39132412)](https://europepmc.org/article/MED/39132412)*

*Groin and adductor: [Tyler TF, Nicholas SJ, Campbell RJ, McHugh MP — "The association of hip strength and flexibility with the incidence of adductor muscle strains in professional ice hockey players", Am J Sports Med, 2001 (PMID 11292035)](https://europepmc.org/article/MED/11292035) · [Tyler TF et al. — "The effectiveness of a preseason exercise program to prevent adductor muscle strains in professional ice hockey players", Am J Sports Med, 2002 (PMID 12239001)](https://europepmc.org/article/MED/12239001) · [Quintana-Cepedal M et al. — "The Copenhagen Adduction Exercise Effect on Sport Performance and Injury Prevention: A Systematic Review With Meta-Analysis", Scand J Med Sci Sports, 2025;35(8) (PMID 40827942)](https://europepmc.org/article/MED/40827942) — **⚠️ RETRACTED (retraction notice: Scand J Med Sci Sports. 2026 Apr;36(4):e70287), the notice finding that the meta-analysis "misrepresents the reported outcomes of two out of the three cited studies, and contains fundamental methodological flaws that invalidate the article's conclusions". The review also rated "the quality of evidence underpinning all findings" as VERY LOW.** Both facts are stated inline in the text; the numbers are reported only because they are the source of the figures quoted there · [Quintana-Cepedal M, de la Calle O, Olmedillas H — "Can the Copenhagen Adduction Exercise Prevent Groin Injuries in **Soccer** Players? A Critically Appraised Topic", J Sport Rehabil, 2024 (PMID 37734743)](https://europepmc.org/article/MED/37734743) — **football population, flagged inline** · [Saito H et al., Cureus, 2025 (PMID 41583230)](https://europepmc.org/article/MED/41583230) · [Fujisaki K et al. — "Effects of a Groin Pain Prevention Program in Male High School **Soccer** Players: A Cluster-Randomized Controlled Trial", Int J Sports Phys Ther, 2022 (PMID 35949380)](https://europepmc.org/article/MED/35949380) — **football population, flagged inline** · [Quintana-Cepedal M et al. — dose-response of the Copenhagen adduction exercise, J Sports Sci, 2024 (PMID 39551738)](https://europepmc.org/article/MED/39551738) — **population is 30 high-level *rink* hockey players aged 14, not ice hockey; flagged inline***

*Hockey injury epidemiology: [Keshen S et al. — "Musculoskeletal Injuries in National Hockey League Goaltenders", Am J Sports Med, 2025 (PMID 40653669)](https://europepmc.org/article/MED/40653669) · [Zheng Y, Liu Y, Chen Y, Cao J, Chen E, Pan H, Huang P — "Research Progress on Common Sports Injuries Among Youth Ice Hockey Players **and Prevention Strategies: A Narrative Review**", Sports (Basel), 2025;13(12) (PMID 41441433)](https://europepmc.org/article/MED/41441433) — **a narrative review, and its own Methods say so**: a literature search *"for publications between August 2015 and August 2025"*. The **11.7–34.4 per 1000 athlete-hours** range, the threefold concussion figure and the 50–70% policy reduction are all **synthesised from its references, not measured by it** · [Abrahamson J, Lindman I, Jónasson P, Tegner Y — "High prevalence of former elite ice hockey players requiring early hip arthroplasty surgery", J Hip Preserv Surg, 2024 (PMID 39664208)](https://europepmc.org/article/MED/39664208) — **the 81% cam figure is from 31 players who sought orthopaedic consultation for hip and groin pain; a symptomatic clinic sample, flagged inline** · [Martin M, Bullock GS, Galarneau JM, Schneider G, Emery CA, Mohtadi NG — "Examining Symptoms, Clinical, and Radiographic Signs of Femoroacetabular Impingement Syndrome in Youth Ice Hockey and Ringette Athletes, Part 2", Clin J Sport Med, 2026;36(2) (PMID 41931369)](https://europepmc.org/article/MED/41931369) · [Martin M, Soligon C, Galarneau JM, et al. — "Evaluating the Prevalence of Signs and Symptoms Associated With Hip-Related Groin Pain in Youth Ice Hockey and Ringette, Part 1", Clin J Sport Med, 2026 (PMID 41947288)](https://europepmc.org/article/MED/41947288) · [Laaksonen J, Pakarinen O, Vaajala M, Liukkonen R, Kuitunen I — "Lower limb injuries and concussions dominate in collegiate women's ice hockey: a systematic review and meta-analysis", BMJ Open Sport Exerc Med, 2026;12(1):e002684 (PMID 41657371)](https://europepmc.org/article/MED/41657371) · [Dinh J, Reiad M, Wang J, et al. — "Breaking the Ice: Patterns and Prevalence of Upper Extremity Injuries in Youth Ice Hockey Players Over a 20-Year Study Period", Hand (NY), 2026;21(7):1197–1205 (PMID 40741926)](https://europepmc.org/article/MED/40741926) · [Reiad M, Dinh J, Khan A, et al. — "Epidemiology of acute ice-hockey-related orthopedic fractures in high school- and college-aged players in the United States from 2006-2023", Eur J Trauma Emerg Surg, 2026;52(1):117 (PMID 41925829)](https://europepmc.org/article/MED/41925829) — **shoulder 27.0%, wrist 19.3%, lower arm 11.3%**; the 27.0% is frequently misquoted elsewhere as a hand figure*

*Concussion: [Patricios JS et al. — "Consensus statement on concussion in sport: the 6th International Conference on Concussion in Sport — Amsterdam, October 2022", Br J Sports Med, 2023 (PMID 37316210, doi:10.1136/bjsports-2023-106898)](https://europepmc.org/article/MED/37316210) · [Concussion Recognition Tool 6 (CRT6), Echemendia RJ et al., Br J Sports Med 2023;57:692–694 (doi:10.1136/bjsports-2023-107021)](https://bjsm.bmj.com/content/57/11/692) — the ten red flags, all five instructions in the "Remember" box ("In all cases, the basic principles of first aid should be followed: assess danger at the scene, check airway, breathing, circulation; look for reduced awareness of surroundings or slowness or difficulty answering questions"; "Do not attempt to move the athlete (other than required for airway support) unless trained to do so"; "Do not remove helmet (if present) or other equipment"; "Assume a possible spinal cord injury in all cases of head injury"; "Athletes with known physical or developmental disabilities should have a lower threshold for removal from play"), and the "Athletes with suspected concussion should NOT" list (not left alone for at least the first 3 hours; not sent home by themselves; no alcohol or recreational drugs; no driving until cleared by a healthcare professional). **The two exceptions belong to the moving instruction; the helmet instruction carries none, and is quoted here as it stands in the tool.** Both content pages of the published PDF are images rather than text — a text extraction returns only the journal's own stamp and page furniture — so the tool was rendered and read by eye on 31 August 2026. CRT6 is free to copy in its current form and belongs on your phone · SCAT6, published alongside the same consensus · [UK Concussion Guidelines for Non-Elite (Grassroots) Sport](https://sportandrecreation.org.uk/campaigns-and-policy/concussion/concussion-guidelines-for-grassroots-sport) — the November 2024 update, read 31 August 2026; the source for the British red-flag list quoted above, including "Severe neck pain", "Amnesia (no memory) for events before or after the injury", "Unusual behaviour change", "Current 'blood-thinning' therapy" and "Current drug or alcohol intoxication" · [England Ice Hockey — Safer Sport](https://englandicehockey.com/safer-sport/), retrieved 31 August 2026 — the source for England Ice Hockey's adoption of that guidance*

*Warm-up and injury prevention programmes: [Zarei M et al. — adherence to FIFA 11+, Am J Sports Med, 2026 (PMID 41981827)](https://europepmc.org/article/MED/41981827) · [Gu J et al. — adherence and hamstring injury, Ann Med, 2026 (PMID 41945463)](https://europepmc.org/article/MED/41945463) · [Liu H, Liu X, Yin L — "Effects of multicomponent exercise injury prevention programs on adolescent team athletes (10-19 years old): a systematic review and meta-analysis", Front Pediatr, 2025;13:1561993 (PMID 41574355)](https://europepmc.org/article/MED/41574355) — **the source of the IRR 0.65 / 35% figure; adolescent team athletes across sports, not FIFA 11+ specifically and not hockey** · [Eser C et al. — FIFA 11+ and ankle injury, Muscles, 2025 (PMID 40843917)](https://europepmc.org/article/MED/40843917) · [Patel P, Shah M — "The Impact of the FIFA 11+ Injury Prevention Program on Injury Incidence in Football Athletes: A Systematic Review of Randomized Controlled Trials", Cureus, 2025;17(12):e100463 (PMID 41625863)](https://pmc.ncbi.nlm.nih.gov/articles/PMC12856364/) — **the source of the "30% to 46%" range; football players, narrative synthesis rather than meta-analysis, flagged inline***

*Stretching: [Aouadi R et al. — static vs dynamic stretching and repeated sprint, Sports, 2025 (PMID 40863784)](https://europepmc.org/article/MED/40863784) · [Longo S et al., Sports Med Open, 2025 (PMID 41201748)](https://europepmc.org/article/MED/41201748) · [Warneke K et al. — stretch training and injury prevention, J Sport Health Sci, 2025 (PMID 40513717)](https://europepmc.org/article/MED/40513717)*

*Nutrition and hydration: [Nordstrøm A — "Nutrition for Elite Male Ice Hockey", Int J Sport Nutr Exerc Metab, 2026 (PMID 42362109)](https://europepmc.org/article/MED/42362109) · [Heesch AJ et al. — body water changes in collegiate ice hockey, J Strength Cond Res, 2025 (PMID 40267420)](https://europepmc.org/article/MED/40267420) · [Gavel EH, Rae S, Logan-Sprenger HM — "Fluid balance of **female** para hockey players during simulated competition", Front Sports Act Living, 2024 (PMID 39654844)](https://europepmc.org/article/MED/39654844) · [Csanaky L et al. — post-exercise nutrition knowledge in amateur **endurance** athletes, Nutrients, 2025 (PMID 41305679)](https://europepmc.org/article/MED/41305679)*

*Recovery methods: [Vatne E, Oliva-Lozano JM, Saenz C, Cost R, Hagen J — "Post-Exercise Recovery Modalities in Male and Female Soccer Players of All Ages and Competitive Levels: A Systematic Review", Sports (Basel), 2025;13(10):343 (PMID 41150478)](https://europepmc.org/article/MED/41150478) — **soccer population, flagged inline**; source of the "consistently improved jump performance and perceptions of fatigue, soreness, and overall well-being" quotation · [Yu T et al. — CWI protocol optimisation network meta-analysis, BMC Sports Sci Med Rehabil, 2026 (PMID 41845491)](https://europepmc.org/article/MED/41845491) · [Betz MW et al. — "Postexercise Cooling Lowers Skeletal Muscle Microvascular Perfusion and Blunts Amino Acid Incorporation into Muscle Tissue", Med Sci Sports Exerc, 2025 (PMID 40249909)](https://europepmc.org/article/MED/40249909) · [Veen J et al. — CWI in soccer players, Scand J Med Sci Sports, 2026 (PMID 41490103)](https://europepmc.org/article/MED/41490103) · [Zhu Y et al. — CWI outcome-specific effects, PeerJ, 2026 (PMID 42473449)](https://europepmc.org/article/MED/42473449) · [Engel F et al. — compression garments, Physiol Rep, 2026 (PMID 41693319)](https://europepmc.org/article/MED/41693319) · [Hou C et al. — comparative recovery modalities, Healthcare, 2026 (PMID 42194413)](https://europepmc.org/article/MED/42194413) · [Driller M, Leabeater A — recovery strategies review, Sports, 2023 (PMID 37999430)](https://europepmc.org/article/MED/37999430)*

*Sleep: [Kaczmarek F et al. — "Sleep and Athletic Performance: A Multidimensional Review", J Clin Med, 2025 (PMID 41227002)](https://europepmc.org/article/MED/41227002) · [Juginović A, Rodman L — sleep banking, Clocks Sleep, 2026 (PMID 41892386)](https://europepmc.org/article/MED/41892386) · [Tawfeeq R, Malm CB — sleep duration and injury risk, preprint, 2025 (PPR1110297)](https://europepmc.org/article/PPR/PPR1110297)*

*In-season and off-season training: [Qu W et al. — in-season flywheel resistance training dose-response, BMC Sports Sci Med Rehabil, 2026 (PMID 41546061)](https://europepmc.org/article/MED/41546061) · [Bousselmi M et al. — 12 weeks of in-season strength training, Sports, 2026 (PMID 42043068)](https://europepmc.org/article/MED/42043068)*

*Youth resistance training (consensus and position statements, abstracts retrieved from Europe PMC 2 September 2026; neither full text read): [Lloyd RS, Faigenbaum AD, Stone MH, Oliver JL, Jeffreys I, Moody JA, et al. — "Position statement on youth resistance training: the 2014 International Consensus", Br J Sports Med 2014;48(7):498–505, doi:10.1136/bjsports-2013-092952 (PMID 24055781)](https://europepmc.org/article/MED/24055781) — *"adapted from the official position statement of the UK Strength and Conditioning Association"* and *"has subsequently been reviewed and endorsed by leading professional organisations within the fields of sports medicine, exercise science and paediatrics"* · [Faigenbaum AD, Kraemer WJ, Blimkie CJR, Jeffreys I, Micheli LJ, Nitka M, Rowland TW — "Youth resistance training: updated position statement paper from the National Strength and Conditioning Association", J Strength Cond Res 2009;23(5 suppl):S60–79 (PMID 19620931)](https://europepmc.org/article/MED/19620931) — *"resistance training can offer unique benefits for children and adolescents when appropriately prescribed and supervised"*. **Both are consensus/position statements rather than trials, and neither is about ice hockey.***

*Youth development: [Thurber L, Kantrowitz DE, Wang KC, Jayanthi N, Colvin A — "Early Sport Specialization and Intense Training in **Junior Tennis** Players: A Sport-Specific Review", Sports Health, 2026 (PMID 41272920)](https://europepmc.org/article/MED/41272920) — **tennis population; the three numeric thresholds quoted are the general youth-sport recommendations it restates, flagged inline** · [Zinke TJ et al. — early specialisation and chronic injury, J Sport Rehabil, 2026 (PMID 42463116)](https://europepmc.org/article/MED/42463116) · [Chundi G et al. — specialisation and NFL career outcomes, Eur J Sport Sci, 2026 (PMID 41527183)](https://europepmc.org/article/MED/41527183) · [Li L et al. — physiological mechanisms in youth musculoskeletal injury, Front Physiol, 2026 (PMID 42266238)](https://europepmc.org/article/MED/42266238)*

*The literature here is drawn from the [Europe PMC REST API](https://europepmc.org/RestfulWebService). Individual publisher pages (bjsm.bmj.com and others) are not publicly accessible, so abstracts and the quoted passages come from Europe PMC records rather than publisher full text.*
...
- ***Shifts per game.*** *The NHL's public stats API publishes a `shiftsPerGame` and a `timeOnIcePerShift` field per skater. The figures in the text are computed from the NHL time-on-ice report for the **2024-25 regular season** (the regular-season game type), restricted to the 597 skaters with 41 or more games played — forwards 19.4 shifts per game (median 19.6), defencemen 24.0 (median 24.4), all skaters 21.0, with a 10th-to-90th-percentile spread of 16.0 to 26.1 and mean shift lengths of 47.2 s for forwards, 48.8 s for defencemen and 47.8 s across all of them. **How they are derived, so that anyone can repeat them:** take every skater row the report returns for that season; count positions C, L and R as forwards and D as defencemen; apply the 41-games filter; and take the plain unweighted mean, or median where one is quoted, of the per-skater field across those skaters — the league totals are not pooled, which together with the games filter is the whole of the difference from [Defender](../positions/defender.md) below. **Recomputed on 2 September 2026**, when the report returned 920 skater rows for the season and 597 of them at 41 or more games; the unrounded results were 19.4145 and 24.0468 shifts per game, and 47.2074 s for forwards, 48.8404 s for defencemen and 47.7572 s across all 597 — which is the same 47.2074 and 48.8404 weighted by the 396 forwards and 201 defencemen behind them, so the headline figure and the two beside it in the text stand or fall together. ⚠️ **This is a live statistics endpoint rather than a fixed publication, so each of these figures is a function of the day it was computed** — a later run can return something different, and the date above is what it should be checked against. Anyone repeating it should ask the report for an explicit sort order: paged without one, it returns some skaters twice and drops others, which moves the count and the means. This is NHL regular-season data and should not be read across to junior, women's or rec hockey. **[Defender](../positions/defender.md) computes shift length from the same report over a wider population — every skater who took a shift, pooling total ice time over total shifts instead of averaging the per-skater field — and gets 47.4 s for forwards and 48.7 s for defencemen for this same 2024-25 season, alongside its headline 2025-26 pair of 47.6 s and 49.3 s.** Both pairs are this corpus's own arithmetic on the same public report; the small differences are the population filter and the aggregation, and neither corrects the other. A third and narrower computation — mean 47 s, median 45 s across 8,325 shifts in an 11-game 2024-25 convenience sample, from the shift-chart API rather than this report — is set out in [Playing Without the Puck](../hockey-iq/playing_without_the_puck.md#notes-on-verification) and is not positional. The 30–80 second shift range and 15–25 minutes of on-ice time are sourced separately (Vigh-Larsen and Mohr 2024), and the bench-recovery figure is sourced too: the elite-hockey nutrition review (Nordstrøm 2026) describes shifts "interspersed with passive recovery periods (2-5 min)".*
...
- ***The "enthusiasm" claim about how an adult amateur gets hurt.*** *A coaching observation, labelled as one inline, not a measured ranking. Nothing cited in this document compares the causes of amateur hockey injury by frequency: the injury literature here measures setting (Laaksonen and colleagues 2026 — games 10.10 against practices 3.11 per 1000 athlete-exposures), injury type (concussion the most common in that dataset), body region (Dinh and colleagues 2026; Reiad and colleagues 2026) and one strength risk factor (Tyler and colleagues 2001) — none of them cause. [Practice and Development](practice_and_development.md) makes the same observation, labels it the same way, and records the database searches behind it.*
...
- ***The Copenhagen adduction exercise meta-analysis (PMID 40827942) has been retracted*** *(April 2026), and rated the certainty of all its own findings as very low. Its figures appear in the text with both facts attached, rather than being dropped, because a retracted number a reader may meet elsewhere is more useful labelled than absent. Do not build a programme on them.*
- ***Resistance training for youth — what the two statements are, and what they are not.*** *The safety of supervised, appropriately prescribed youth resistance training is stated by Lloyd and colleagues' 2014 International Consensus (PMID 24055781) and by the NSCA's updated position statement (PMID 19620931), both cited inline and in the Sources above. **Neither is a trial and neither is about ice hockey**: they are a field's consensus, and both put the conditions — appropriate prescription and supervision — inside the claim rather than beside it, which is why the text carries them that way. **Nothing narrower was found for this sport: Europe PMC was searched on 2 September 2026 for "resistance training" or "strength training" together with "ice hockey" and with injury, in titles and in abstracts, against a positive control of 1,084 records with "ice hockey" in the title — no study of resistance-training injury rates in youth ice hockey players came back**, and none is asserted here. The wording quoted is from the Europe PMC abstract records, retrieved 2 September 2026; neither full text was read.*
