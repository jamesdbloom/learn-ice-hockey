...
And the NHL's escalation for disputing a ruling is explicit: persisting after the unsportsmanlike-conduct minor gets you a **misconduct** (NHL Rule 39.4(iii)), and persisting after that gets you a **game misconduct** (NHL Rule 39.5(i)). NHL Rule 39.4(ix) states the ladder in one line: "participants displaying this type of behaviour are assessed a minor penalty, then a misconduct penalty and then a game misconduct penalty if they persist."
