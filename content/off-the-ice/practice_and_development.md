...
> differ in a way that changes how you play, it is flagged inline. Almost none of the *content* of
> this document changes between rule sets. **Two things do.** The first is equipment:
> England Ice Hockey's *Rules & Regulations* 24.3 make an approved neck guard mandatory
> *"whilst participating in all on ice activities"* — so in England and Wales it is required at
> practice and not only in games. See [Equipment](equipment.md). The second is what happens
> when a shot hits your goaltender's mask, where every book stops play for an injured goalkeeper but only two trigger on the hit itself —
> see [During the drill](#during-the-drill). What else changes
...
**Give every repetition a specific goal, and find out before the next one whether it worked.** Work at the edge of what you can already do reliably, correct one thing, go again. And get an outside eye on it — a coach, a training partner, or a phone on a tripod — because you cannot see your own stride, and that is the part amateurs leave out and the part that costs most.

**Skating first, puck handling with your head up second, passing and receiving third, shooting fourth — but that order is a coaching choice, not a law of hockey.** A realistic alternative is to fix whatever is actively costing you the most, and a goaltender's priority list is different again. Find out what your own coach prioritises and why. Whichever order you take, *head up* is the operative half of the second one: handling the puck with your eyes down builds a habit you will spend months unlearning.

**Do every repetition at game pace.** Half-speed reps build half-speed skills, and the gap between practice pace and game pace is where players discover their technique does not survive. If a drill is too fast to do cleanly at full speed, that is the drill working correctly — don't cheat the rep to make it look tidy.

**If you get a say in how ice time is spent, ask for small-area games.** A live game in a restricted space puts the puck on your stick far more often than a lineup drill does, which is why USA Hockey builds much of its development material around them. A full game hands you very little time on the puck however good you are, so anything that raises your touches beats another rep in a queue.

**When you change a technique, decide it is permanent before you start.** It will feel worse before it feels better, and most players abandon the change right before it would have started to pay off. Judge it on a retention test — the skill tried cold, a week later, at the start of a session — rather than on how the session felt.

**Don't shoot at your goalie's head, and don't fire pucks at them from ten feet in a drill.** Their job, unlike everyone else's in the drill, is not to move out of the way. ⚠️ **Do not expect the whistle to cover you if you get it wrong** — only two of the five books this guide works from stop play for the hit itself, both are narrower than they sound, and every book's injury stoppage waits on a referee judging the goalie hurt, which a cage makes hard to see. Aim at the pads and the glove, and shoot from where the drill puts you.

**Progress volume or intensity, never both at once.** The most common way amateurs get hurt while developing is not contact but a sudden jump in training load — a coaching observation rather than a measured ranking — and the place it happens is the first week back from a layoff, when your competitiveness returns faster than your tissue does.

## Overview

**Decide what your hours are for, because counting them tells you nothing.** The 10,000-hour rule was never a research finding, and the violinist study it was drawn from did not replicate. Read that as a null rather than a reversal: it does not show practice is unimportant, it shows that accumulated hours do not rank people. The practical consequence lands on your own week — *"I skate three times a week"* is not a measure of your development, and if you want one you have to build it out of what you worked on and how you knew whether it worked.

**So build the hour rather than count it.** One thing you are working on, a way of finding out this rep whether it worked, and difficulty set just past what you can already do reliably. The piece amateurs leave out is the outside eye, and it is the piece that decides whether the other three do anything at all: you cannot see your own stride, so a coach, a training partner or a phone on a tripod is not a luxury — it *is* the feedback, and without feedback you are rehearsing your errors rather than removing them.

**Expect a change to cost you before it pays you.** Improvement is a staircase rather than a line, and a rebuilt movement pattern is worse than the grooved one it replaced for a while. Because how a session *felt* is a poor guide to what you learned, the decision to stick with a change has to be made before you start and reviewed on a cold retention test — not on the drive home, and not at the bottom of the dip, which is where players give up on it.

**Then spend what little practice you have on what limits you most.** The ordering used here — skating, then puck handling with your head up, then passing and receiving, then shooting — is a coaching choice rather than a law of hockey, and one realistic alternative is simply to fix whatever is actively costing you games. Notice that it runs close to the reverse of the order in which those things are fun, which is the standing problem with self-directed practice: left alone, you will take shots and avoid edges.

**Two constraints shape everything else.** You get very little ice, and even on the ice a game hands you almost no time with the puck — so the ice you do get is best spent live, contested and in a small space, and most of the volume has to happen off it. Off-ice work earns its place by reproducing what the real task actually demands, which is why head-up stickhandling and wall passing buy so much and agility ladders so little. The same test cuts the other way too: a drill you do badly, often enough, is worse than not doing it at all, because you then have to unlearn it.

**Development stops entirely when you are hurt, and contact is not the main hazard for a developing amateur.** A sudden jump in training load is, most often in the first week back from a layoff — and that ranking is a coaching observation rather than a measured one.
...
### One popular idea that is contested, not settled
...
### One popular idea to drop entirely
...
### One popular idea that does hold up — with a precondition attached
...
| Final test | Restudied | Tested |
|---|---|---|
| 5 minutes later | **81%** | 75% |
| 2 days later | 54% | **68%** |
| 1 week later | 42% | **56%** |
...
The practical reading: external cues are free, harmless and a reasonable default, but **if an internal cue is the only way you can feel a correction, use it.** See [Mental Game](mental_game.md), which covers the same dispute for in-game self-talk. (Wulf 2013 is cited here for its central argument only, with no effect size attached to it.)

---

## What to Practise, in Priority Order

> **This ordering is a coaching choice, not a rule of hockey.** It is the order recommended here for a typical amateur skater. A realistic alternative is *fix what is actively costing you*: if you are a competent skater who cannot receive a pass, the drill you need is not edge work. A third alternative is position-led: a goaltender's priority list is different again (see [Goaltender](../positions/goaltender.md)). Find out what your own coach prioritises and why.
...
Specifically, the highest-leverage items for most amateurs are **knee bend, outside edges, stopping both ways, and backward crossovers**. Full technique is in [Skating](../technique/skating.md).
...
Everything you do in this category should be done with your eyes off the puck. Full technique in [Puck Handling](../technique/puck_handling.md).
...
Practise: soft hands (giving with the puck), receiving on your backhand, receiving with your feet moving, and one-touch redirection. Full technique in [Passing and Receiving](../technique/passing_and_receiving.md).
...
**The largest version of this problem is a change of position**, where the habits working against you were correct in your old job and are automatic under pressure. [Switching Positions](../positions/switching_positions.md) catalogues them switch by switch.
...
- **Timing your support** rather than just knowing where to stand — see [Puck Support and Spacing](../hockey-iq/puck_support_and_spacing.md).
- **Manufacturing and exploiting separation** in a space that keeps taking it away — see [Time and Space](../hockey-iq/time_and_space.md).
- **Deception**, which only exists when there's someone to deceive.
- **Puck protection under genuine contact** — see [Body Contact and Battles](../technique/body_contact_and_battles.md).
- **Scanning**, because the picture changes constantly — see [Scanning and Anticipation](../hockey-iq/scanning_and_anticipation.md).
...
- **Rec and beer-league note:** most rec teams get one ice slot with no practice at all. If that's you, ask whether your rink runs stick-and-puck or drop-in small-area sessions; they are usually the cheapest and highest-value ice you can buy. ([Getting Started](../getting-started/getting_started.md) explains what stick-and-puck, drop-in and shinny each usually mean, what gear each requires, and what to ask at the desk.)

---

## Making the Most of Team Practice

> **The habits in this section are coaching craft, not research findings.** They are what experienced players and coaches do with a practice; no study of how much two players get out of the same session was found for this document.
...
- **Keep your feet moving.** Standing still for 45 minutes in cold air is how you pull something on your next hard rep, and it wastes conditioning time. See [Conditioning and Recovery](conditioning_and_recovery.md).
...
- **Rehearse.** Picture your next rep, specifically — see [Mental Game](mental_game.md).
...
- **Add a constraint that forces a scan.** Rule: you must shoulder-check before every reception. Rule: you cannot pass to the player who passed to you. Both force your head up and your options open. See [Scanning and Anticipation](../hockey-iq/scanning_and_anticipation.md).
...
- **Practise the decision to do nothing.** Amateurs default to action — dumping it, forcing it, shooting it into shins. Rehearse holding the puck for one more beat, or making the boring lateral pass. See [Risk Management](../hockey-iq/risk_management.md).
...
A cheap and effective off-ice drill: find a game clip, play it, and **pause at the instant a player receives the puck.** Say out loud what you would do and why. Then play on and see what happened. Do this twenty times and you're training the same perceptual skill the game demands, at a speed you can actually think at. Full method in [How to Watch Hockey](how_to_watch_hockey.md).
...
> **These plans are coaching craft — an example structure, not a prescription.** The evidence base does not support any specific weekly template. What it supports is the general principle: focused, feedback-rich, edge-of-ability work beats volume. Adapt freely.
...
| When | What | Why |
|---|---|---|
| 3 × 15 min, weekday evenings | **Head-up stickhandling** on a pad or smooth floor | Highest transfer per minute of anything off-ice; fits in a normal evening |
| 2 × 10 min | **Wall passing / rebounder**, half of it backhand | Receiving is the more neglected half of passing — coaching observation, not a count |
| 1 × 20 min | **Shooting** off a pad into a net — quantity low, quality high, vary the release point | Mechanics only; the decisions come on ice |
| 2 × 30–40 min | **Strength and mobility**, emphasis on single-leg work, hips and adductors | Supports the stride; the main injury protection ([Conditioning and Recovery](conditioning_and_recovery.md)) |
| 10 min before every skate | **Edge work** — inside and outside edges, both directions, before the puck comes out | The only way most adults ever get dedicated skating time |
...
**This section assumes you have already found a session to go to.** If you have not, [Getting Started](../getting-started/getting_started.md) is the document for that — adult learn-to-skate and learn-to-play routes, what to sign up for, and what happens in your first hour at the rink.

> **A note on timelines before you read any further.** You will see confident figures for how long adult beginners take — including in the "Realistic timelines" section below. **Every one of them comes from coaching providers and retailers, not from research.** There is no measured evidence for any adult-beginner timeframe. Read them as experienced guesses with enormous individual variation, and do not measure yourself against them.
...
- **Fear of falling, and its consequences.** Adults fall from higher, weigh more, and have jobs on Monday. That fear makes you stand up straight and lock your legs — and standing tall is the root cause of most skating faults ([Skating](../technique/skating.md)). The fear is thus not just uncomfortable; it is *technically* the problem.
- **Hours.** A ten-year-old gets four sessions a week for a decade. You get one or two, with cancellations.
- **Recovery.** You will need more of it and you'll get less. See [Conditioning and Recovery](conditioning_and_recovery.md).
...
- **Money.** Power skating, a coach for three sessions, better-fitting protective gear — all of these buy real progress and are available to adults ([Equipment](equipment.md)).
- **Watching hockey intelligently.** You can learn a great deal from television that a child watching the puck cannot.

### Practical first steps

- **Learn to fall — and learn to get up — deliberately, in full gear.** Coaching guidance is consistent on this and the reasoning is sound: removing the fear is what lets you bend your knees, and bending your knees is the whole game. **But do not practise it on the assumption that the gear makes a fall harmless.** Full kit absorbs a great deal; it does not cover a wrist you put out to catch yourself, and a fall is one of the ways a concussion happens ([Conditioning and Recovery](conditioning_and_recovery.md#concussion)). A rehearsed fall costs you a bruise and an unrehearsed one can cost you a wrist or a head — which is the reason to rehearse the **technique**, rather than simply to fall over a lot. **Get low first, go down to the side onto hip and thigh, and keep your hands in rather than out onto a locked, straight arm** — that last part is widely taught coaching craft rather than a sourced rule, and [Body Contact and Battles](../technique/body_contact_and_battles.md) sets out what it does and does not rest on. **The chin has two opposite cases and you need the right one. Falling backwards to the ice: tuck your chin in, because it keeps the back of your skull off the ice. Going forwards into the boards: do not tuck it. Head up, never duck, because a chin on your chest straightens the neck to take the load down its length. Falling flat: chin in. Hitting a wall: head up.** Then take two or three seconds to check you are not hurt before you get up, and stay down if you are. [Skating](../technique/skating.md#falling-and-getting-up) has the full version and the get-up sequence.
...
Full detail, including specific hip and adductor work, is in [Conditioning and Recovery](conditioning_and_recovery.md).
...
1. Someone tells you 10,000 hours is what separates experts from everyone else.
   Where did the number come from, what happened when the founding study was
   replicated, and how much of the variance in sports performance does deliberate
   practice actually explain? *(§What the evidence actually supports — and what
   it doesn't)*

2. What is the priority order this document gives for what to practise — and what
   does it say about the *status* of that order? Name one realistic alternative.
   *(§What to Practise, in Priority Order)*

3. You changed something in your stride and three weeks in you are worse than
   before. What is happening, when do players typically abandon a change, and
   what are the three defences against doing so? *(§New techniques feel worse
   before they feel better, §Why players abandon changes)*

4. Name a form of off-ice practice this document says is worse than doing
   nothing, and explain the mechanism that makes it so. *(§The unlearning problem
   — the serious caution)*

5. You took fifty wrist shots and then fifty snap shots, and someone tells you
   that is the wrong way round. What does the evidence on contextual interference
   actually show in real sport settings, and what is the sensible default? *(§One
   popular idea that is contested, not settled)*

6. The session felt great. Is that evidence you learned anything? What is the
   honest test instead? *(§Test learning, not performance)*

7. Your only ice this week is a game. Roughly how much puck possession does a
   full game give even the best players in the world, and what follows from that
   about what your ice time is for? *(§Small-Area Games)*

8. Your team runs a full-ice drill with no defender in it. What has that drill
   removed, and what would you add to turn an execution drill into a decision
   drill? *(§Practising Decision-Making, Not Just Skills)*
...
12. **Nobody in a drill is more exposed than your goalie, so aim at the pads and the glove and shoot from where the drill puts you.** Don't shoot at their head in the warm-up and don't fire pucks at them from ten feet, because the whistle may not come: **only two of the five books stop play for the hit itself, and both are narrower than they sound** — the IIHF's is a *"may"* that depends on the referee believing the goalie is *"dazed"* and that an immediate scoring chance cancels, Hockey Canada's *"shall"* reaches only *"categories of U13 and below"*, and the NHL, USA Hockey's **stand-up** rules and CARHA write no mask-specific stoppage at all. ⚠️ **Every book does stop play for an injured goalkeeper — but each of those waits on a referee judging them hurt, and a cage is what stops that happening.**
...
14. **The most common way amateurs get hurt while developing is not contact — it is a sudden jump in training load, especially coming back from a layoff, when your competitiveness returns faster than your tissue does — a coaching observation rather than a measured ranking.** Progress volume or intensity, never both at once. Treat a return from a layoff as its own case: this is where groin and hip adductor problems — the classic hockey overuse complaint — tend to appear. Full detail, including specific hip and adductor work, is in [Conditioning and Recovery](conditioning_and_recovery.md).
15. **Learn to fall on purpose, and get the chin direction right, because it reverses depending on what you're falling toward.** Get low, go down onto hip and thigh, and keep your hands in rather than out onto a locked arm. Falling flat to the ice, tuck your chin in. Going into the boards, keep your head up with your chin off your chest — a tucked chin there straightens your neck to take the load. [Skating](../technique/skating.md#falling-and-getting-up) has the full method and the get-up sequence.

---

*Sources — retrieved 27 July 2026:*

*Rules — what happens when a shot hits a goaltender's mask; all four books read in the primary text on 2 September 2026: [IIHF Official Rule Book 2025/26 (Version 1.1)](https://blob.iihf.com/iihf-media/iihfmvc/media/contentimages/3_the_iihf/2025-26_iihf_rulebook_22122025-v1.pdf) — **Rule 9.6**, *"When a goalkeeper is hit on the face mask by a hard shot with the puck and the Referee believes the goalkeeper is, or may be, dazed by that hard shot, the Referee may stop play for safety reasons if there is no immediate scoring chance for the attacking team"*, word for word identical in the 2026/27 edition · [Hockey Canada Playing Rules 2026-2028 (PDF)](https://cdn.hockeycanada.ca/hockey-canada/Hockey-Programs/Officiating/Downloads/2026-28-hc-rulebook-e.pdf) — **Rule 6.18(a) Goaltender Safety**, marked NEW: *"In categories of U13 and below should a Goaltender be struck in the head by the puck the Referee shall stop play as soon as it is safe to do so"* · [NHL Official Rules 2025-2026 (PDF)](https://media.d3.nhle.com/image/private/t_document/prd/slwjuaqwmuvj5bkplixo.pdf) — **Rule 9.6**, which reaches a goalkeeper who *"has lost his helmet and/or face mask"* and not one hit on a mask that stays on · [USA Hockey Official Playing Rules 2025-29 (PDF)](https://cdn2.sportngin.com/attachments/document/945a-3442848/2025-29_USAH_Playing_Rules.pdf) — **Rule 304(e)**, likewise a mask that *"comes off during play"* · [England Ice Hockey Rules & Regulations 2024-2025 (PDF)](https://englandicehockey.com/wp-content/uploads/2024/09/1.0-5.0-EIH-Rules-and-Regulations.pdf) — refetched 22 September 2026, HTTP 200, 1,139,400 bytes; **the source for the neck-guard sentence in the rule-set note at the head of this document**, which is the other of the two things that change between rule sets here. **Rule 24.3**: *"The EIH consider it mandatory that all players at all levels use an approved Ice Hockey Neck Guard/Protector whilst participating in all on ice activities"* — the *"all on ice activities"* limb is what reaches practice and not only games. Read with **Rule 1.1**, which makes England Ice Hockey the National Governing Body *"in England and Wales"* and so sets how far 24.3 reaches. **This is the 2024-2025 edition**, updated annually on England Ice Hockey's own account — **and it was still the latest when this was checked on 22 September 2026**: no later edition appears among the 342 PDFs England Ice Hockey publishes, though its own [Rules and Regulations page](https://englandicehockey.com/rules-and-regulations/) no longer links this document at all, listing a 2026-2027 set of separate regulations in its place. ⚠️ **An EIH or SIHA Rule Bulletin could still have overtaken 24.3 without a new PDF; none has ever been obtained.**; [Equipment](equipment.md) owns the full certification treatment. ⚠️ **That the NHL and USA Hockey's stand-up rules write no stoppage for a mask that stays on is a negative established by search rather than assumed — and the search had to be widened before it was right:** both NHL extractions, the USA Hockey playing rules, the USA Hockey Casebook and the CARHA rule book were searched on punctuation-stripped, whitespace-flattened text for *dazed*, *struck in the head*, *hit in the head*, *hit on the face mask*, *head by the puck*, *struck by the puck*, *puck strikes*, *stop play for safety* and *safety reasons*, returning nothing on point, while the same searches return the quoted sentences in the IIHF and Hockey Canada books — the positive control. ⚠️ **Nine phrasings were still not enough.** USA Hockey writes its clause as *"Should a hard shot hit the goalkeeper's facemask while play is in progress, the play may be stopped at the discretion of the Referee only if no immediate scoring chance is presented to the opposing team"*, matching none of the nine, and puts it in the **Disabled Hockey** section under **Sled Hockey** (`usah.txt:7192`, heading at `usah.txt:6828`; the same clause at `usah_casebook.txt:19772`) — a sled equipment provision, in a section that follows the stand-up rules *"except for some of the equipment"*. `hard shot` returns **1** in each USA Hockey volume and **0** in the NHL and CARHA books, and neither the NHL book nor the Hockey Canada book has a disabled-hockey section at all. ⚠️ **All nine phrasings were about the mask or the head, so none of them could reach the general injured-player rules — and an earlier reading of this passage generalised the mask negative into those.** Every one of the five books writes an injury stoppage that reaches a goalkeeper: **NHL Rule 8.1** and **IIHF Rule 8.1**, each book's **Rule 8.2** presupposing the result in the words *"When play has been stopped by the Referee or Linesperson due to an injured goalkeeper"*; **USA Hockey Rule 206(a)**, which carves goalkeepers out of a *consequence* (*"A player other than a goalkeeper, whose injury appears serious enough to warrant the stoppage of play"*) and so places them inside the stoppage; **Hockey Canada Rule 2.4(b)**; and **CARHA Rule 20(d)**, whose Note 1 — *"[w]here there is suspicion that a player has sustained an injury, the Referee may stop the play immediately"* — is the widest of the five, and whose definition of **Players** settles that it reaches a goalkeeper. **The advice above stands unchanged**, because what makes it necessary is the trigger rather than the absence of a rule: each of those clauses asks an official to judge that a player is hurt, and a goalie behind a cage is the player who gives them least to judge on. **Supplementary discipline and league or association concussion protocols were not searched, and nothing is claimed about them.** [Team Play and Culture](team_play_and_culture.md) carries the fuller treatment, including the pre-game warm-up rules.*

*Deliberate practice and expertise research: [Macnamara, Moreau & Hambrick (2016), "The Relationship Between Deliberate Practice and Performance in Sports: A Meta-Analysis", Perspectives on Psychological Science 11(3), 333–350](https://journals.sagepub.com/doi/abs/10.1177/1745691616635591) ([full text PDF](https://hhs.purdue.edu/skill-learning-and-performance-lab/wp-content/uploads/sites/43/2024/08/macnamara-et-al-2016-the-relationship-between-deliberate-practice-and-performance-in-sports-a-meta-analysis.pdf)) · [Macnamara, Hambrick & Oswald (2014), "Deliberate Practice and Performance in Music, Games, Sports, Education, and Professions: A Meta-Analysis", Psychological Science](https://gwern.net/doc/psychology/2014-macnamara.pdf) · [Ericsson (2016), "Summing Up Hours of Any Type of Practice Versus Identifying Optimal Practice Activities", Perspectives on Psychological Science 11(3), 351–354](https://doi.org/10.1177/1745691616635600) · [Macnamara BN & Maitra M (2019), "The role of deliberate practice in expert performance: revisiting Ericsson, Krampe & Tesch-Römer (1993)", Royal Society Open Science 6(8):190327, doi:10.1098/rsos.190327](https://doi.org/10.1098/rsos.190327) — **a direct, double-blind replication of the founding 1993 violinist study that failed to replicate its major result**; 39 violinists against the original 30; **no statistically significant difference in accumulated practice alone between the best and the good violinists** — a null, not a reversal, and the paper's own descriptive gloss is only that *"the majority of the best violinists had accumulated less practice alone than the average amount of the good violinists"*; variance explained fell from 48% to 26% · [Wikipedia – Practice (learning method)](https://en.wikipedia.org/wiki/Practice_(learning_method)) (used only to summarise Ericsson's criteria and the Gladwell dispute)*

*Motor learning and skill acquisition: [Soderstrom & Bjork (2015), "Learning Versus Performance: An Integrative Review", Perspectives on Psychological Science 10(2), 176–199](https://doi.org/10.1177/1745691615569000) · [Wulf (2013), "Attentional focus and motor learning: a review of 15 years", International Review of Sport and Exercise Psychology](https://doi.org/10.1080/1750984X.2012.723728) · [Chua, Jimenez-Diaz, Lewthwaite, Kim & Wulf (2021), "Superiority of External Attentional Focus for Motor Performance and Learning: Systematic Reviews and Meta-Analyses", Psychological Bulletin 147(6), 618–645](https://doi.org/10.1037/bul0000335) · **the challenge to it:** [McKay B, Corson A, Seedu J, et al. (2024), "Reporting bias, not external focus: A robust Bayesian meta-analysis and systematic review of the external focus of attention literature", Psychological Bulletin (PMID 39480294)](https://pubmed.ncbi.nlm.nih.gov/39480294/) — "moderate to strong evidence of publication bias for all analyses"; bias-corrected effects g = 0.01 (performance), 0.15 (retention), 0.09 (transfer) · [Pinder, Davids, Renshaw & Araújo (2011), "Representative Learning Design and Functionality of Research and Practice in Sport", Journal of Sport and Exercise Psychology 33(1), 146–155](https://doi.org/10.1123/jsep.33.1.146) · [Heathcote, Brown & Mewhort (2000), "The power law repealed: The case for an exponential law of practice", Psychonomic Bulletin & Review](https://doi.org/10.3758/bf03212979)*

*Retrieval practice and the testing effect — retrieved 31 July 2026: [Roediger HL & Karpicke JD (2006), "Test-Enhanced Learning: Taking Memory Tests Improves Long-Term Retention", Psychological Science 17(3), 249–255](https://doi.org/10.1111/j.1467-9280.2006.01693.x) ([full text PDF](http://psychnet.wustl.edu/memory/wp-content/uploads/2018/04/Roediger-Karpicke-2006_PsychSci.pdf)) — **120 (Experiment 1) and 180 (Experiment 2) Washington University undergraduates aged 18–24, TOEFL prose passages, free-recall tests with no feedback**; source for 81%/75% at 5 min, 68%/54% at 2 days, 56%/42% at 1 week, and 61% vs 40% at 1 week in Experiment 2 · [Roediger & Karpicke (2006), "The Power of Testing Memory: Basic Research and Implications for Educational Practice", Perspectives on Psychological Science 1(3), 181–210](https://doi.org/10.1111/j.1745-6916.2006.00012.x) · [Rowland CA (2014), "The effect of testing versus restudy on retention: A meta-analytic review of the testing effect", Psychological Bulletin 140(6), 1432–1463](https://doi.org/10.1037/a0037559) — source for **g = 0.50 (95% CI [0.42, 0.58]) across 159 effect sizes**, 18% of effect sizes negative, the retention-interval and initial-test-type moderators — including free recall at **g = 0.29 (95% CI [0.07, 0.52])** level with recognition in the full data set, and the high-exposure subset in which cued recall (0.72) and free recall (0.81) both exceed recognition (0.36) — and the retrievability breakdown including **no feedback with ≤50% retrieval success at g = 0.03 (95% CI [−0.21, 0.27], k = 17)** against **feedback at g = 0.73 (95% CI [0.61, 0.86], k = 52)**. *Published full text read 29 August 2026; every figure quoted here was located in the paper's Results section and its Table 1 (Full Data Set Categorical Moderator Analyses), where k is the number of effect sizes. The publisher's page is paywalled and the abstract carries none of these numbers* · [Kornell N, Hays MJ & Bjork RA (2009), "Unsuccessful retrieval attempts enhance subsequent learning", Journal of Experimental Psychology: Learning, Memory, and Cognition 35(4), 989–998](https://doi.org/10.1037/a0015729) — "with the stipulation that providing feedback is critical" · [Huelser BJ & Metcalfe J (2012), "Making related errors facilitates learning, but learners do not know it", Memory & Cognition 40, 514–527](https://doi.org/10.3758/s13421-011-0167-z) — **primary source for the relatedness boundary**: 60 Columbia undergraduates analysed in Experiment 1 and 30 in Experiment 2, learning weakly associated or unrelated word pairs; *"no benefit was derived from generating an error when the cue and target were unrelated"*, with Experiment 2 replicating Experiment 1 in a within-participants design. *Published full text read 31 August 2026; the sentence is in the abstract and the finding is restated in the Discussion* · [Metcalfe J (2017), "Learning from Errors", Annual Review of Psychology 68, 465–489](https://doi.org/10.1146/annurev-psych-010416-044022) — the review that collects that boundary rather than measuring it. *Its publisher page serves the abstract and reference list only, and neither carries the finding, so it is cited here as a restater and not as the source* · [Bjork EL & Bjork RA (2011), "Making Things Hard on Yourself, But in a Good Way: Creating Desirable Difficulties to Enhance Learning", in Psychology and the Real World, 55–64](https://bjorklab.psych.ucla.edu/wp-content/uploads/sites/13/2016/04/EBjork_RBjork_2011.pdf) — coins the term to Bjork (1994), and supplies the limit that a difficulty becomes undesirable "if the learner does not have the background knowledge or skills to respond to them successfully" · **the boundary condition:** [van Gog T & Sweller J (2015), "Not New, but Nearly Forgotten: the Testing Effect Decreases or even Disappears as the Complexity of Learning Materials Increases", Educational Psychology Review 27(2), 247–264](https://doi.org/10.1007/s10648-015-9310-x)*

*Contested and debunked ideas: [Pashler, McDaniel, Rohrer & Bjork (2008), "Learning Styles: Concepts and Evidence", Psychological Science in the Public Interest](https://doi.org/10.1111/j.1539-6053.2009.01038.x) · [Ammar et al. (2024), "The Effects of Contextual Interference Learning on the Acquisition and Relatively Permanent Gains in Skilled Performance: A Critical Systematic Review with Multilevel Meta-Analysis", Educational Psychology Review](https://doi.org/10.1007/s10648-024-09892-z) · [Ammar et al. (2023), "The myth of contextual interference learning benefit in sports practice", Educational Research Review](https://doi.org/10.1016/j.edurev.2023.100537) · [Czyż (2025), "Commentary on Ammar et al. (2024)", Educational Psychology Review](https://doi.org/10.1007/s10648-025-10006-6) — **abstract read 2 September 2026; the full text is paywalled and was not obtained.** The abstract describes the piece as "a constructive analysis" which commends the authors for "significant advancements", raises database selection, pre-registration and study classification, and "highlights areas for improvement while recognizing the authors' contribution"*

*Small-area and small-sided games: [USA Hockey, "Small Area Competitive Games" handbook (Coaching Education Program), including the 2002 puck-possession study](https://cdn1.sportngin.com/attachments/document/38c0-3079160/USA_Hockey_Small_Area_Competitive_Games.pdf) — **PDF read 2 September 2026. The possession study is a single page of bullet figures for six groups: the handbook states no method, no sample size and no definitions, and the words "video", "tracked", "sample" and "methodology" appear nowhere in it** · [USA Hockey – Small-Area Games](https://www.usahockey.com/smallareagames) · [Clemente et al. (2021), "Effects of Small-Sided Game Interventions on the Technical Execution and Tactical Behaviors of Young and Youth Team Sports Players: A Systematic Review and Meta-Analysis", Frontiers in Psychology 12:667041](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2021.667041/full) · [Clemente, Afonso & Sarmento (2021), "Small-sided games: An umbrella review of systematic reviews and meta-analyses", PLOS ONE](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0247067)*

*Off-ice training and transfer: [Novák, Lipinska, Roczniok, Spieszny & Stastny (2019), "Off-Ice Agility Provide Motor Transfer to On-Ice Skating Performance and Agility in Adolescent Ice Hockey Players", Journal of Sports Science and Medicine 18, 680–694](https://www.jssm.org/jssm-18-680.xml-Fulltext) — **n = 14, age 14.8 ± 0.45 years, all from one team at a single Czech academy; four-week crossover, two groups of seven.** This is the only experimental evidence behind the off-ice conditioning section, and its participants are academy juniors, not the adult amateurs this document addresses · [Rice et al. (2024), "The relationship between off-ice testing and on-ice performance in male youth ice hockey players", Frontiers in Sports and Active Living](https://www.frontiersin.org/journals/sports-and-active-living/articles/10.3389/fspor.2024.1418713/full) — **full text read 2 September 2026. n = 11.** Twenty-four of 33 off-ice variables correlated with at least one on-ice measure; the nine that correlated with none were "height, grip strength (either hand or combined), curl-ups, trunk flexibility, and Wingate-derived absolute power (minimum, mean, and peak)". **The paper disagrees with itself about the players' age** — its abstract gives 9.8 ± 1.1 years, its Table 1 gives 10.5 ± 0.6 with a range of 9.1–11.2; the table's figures are the ones used here · [How To Hockey – Hockey Shooting Pad Information](https://howtohockey.com/hockey-products/hockey-shooting-pad-information/)*

*Roller-to-ice transfer — two coaching opinions and no study; both pages read 2 September 2026: [Coach Chic – Transitioning from Wheels to Ice Hockey](https://coachchic.com/transitioning-from-wheels-to-ice-hockey/) — source for the quoted sentence on stopping and turning, for "not a bad thing — it's just part of the process", and for its closing view that experience on both surfaces is "actually a huge advantage" · [Madison Rec Hockey – Using Roller Hockey to Build Ice Hockey Skills: Busting Myths](https://www.madisonrechockey.com/news/using-roller-hockey-to-build-ice-hockey-skills-bus) — source for "translate seamlessly to the rink" and for the named professionals. **This is a rec league's own article promoting a youth roller programme it is seeking support to launch, so read it as an interested party**, and note that its evidence bullet cites "[s]tudies, like those from the American Development Model (ADM)" without naming one*

*Adult beginners (commercial coaching guidance, not measured findings): [Better Hockey – How to Start Playing Hockey as an Adult](https://www.betterhockey.com/blogs/hockey-training/how-to-start-playing-hockey-as-an-adult) · [Better Hockey – Learn to Skate as an Adult](https://www.betterhockey.com/blogs/hockey-training/learn-to-skate-as-an-adult)*

*Distribution of practice (motor skill): [Lee TD & Genovese ED (1989), "Distribution of practice in motor skill acquisition: different effects for discrete and continuous tasks", Research Quarterly for Exercise and Sport 60(1), 59–65 (PMID 2489826)](https://europepmc.org/article/MED/2489826) · [Panchuk D, Spittle M, Johnston N & Spittle S (2013), "Effect of practice distribution and experience on the performance and retention of a discrete sport skill", Perceptual and Motor Skills 116(3), 750–760 (PMID 24175450)](https://europepmc.org/article/MED/24175450) — **both cited only to show that this literature is unsettled, not to support a schedule.** Abstracts read via Europe PMC on 31 August 2026; neither full text was obtained*

*Limits and caveats: (1) The Ericsson, Krampe & Tesch-Römer (1993) paper is not quoted directly here, so the exact wording of its criteria is not given; its definition of deliberate practice and the origin of the 10,000-hour figure are reported from secondary summaries, from Ericsson's own 2016 commentary, and — for the original's headline result and its 48% variance figure — from **Macnamara and Maitra's 2019 direct replication, which quotes the original**. (2) Wulf (2013) and Heathcote et al. (2000) are not quoted; those claims are stated at the level of the papers' central arguments, with no effect sizes or figures. (3) The USA Hockey handbook reports a claim, attributed to George Kingston from a 1971 study, that around 180 games would be needed to equal one hour of quality puck-control practice; that study is untraced, and the figure is not repeated as fact here. (4) The adult-beginner timeframes (6–10 hours to confident forward skating, 3–6 months to league play, one to two seasons to comfortable hockey) come from a single commercial coaching source and are experienced guesses, not measurements. (5) Claims about the transfer of specific off-ice tools — shooting pads, slide boards, synthetic ice, agility ladders, balance boards — are reasoned from the specificity and representative-learning-design literature plus coaching consensus; no controlled trial of these specific tools in hockey has been published. The How To Hockey page listed above is a product page covering pad material, size, durability and price; the surface-friction and shooting-off-concrete points in that section are coaching craft and are not taken from it. (6) How much roller hockey costs a player's ice-skating mechanics is not settled. The two coaching sources cited agree on the recommendation — both say the puck skills carry over and both recommend playing on wheels — but they differ on the skating itself: one has players going back to basics for a while to rebuild the ice stride and the quick stops, the other says the mechanics translate seamlessly. Neither is evidence, one of the two is a league promoting a roller programme of its own, and no study of roller-to-ice transfer is cited here. (7) The priority ordering of skills, the weekly plans, and the team-practice habits in this document are coaching craft, not research findings, and are labelled as such in the text. (8) Groin and hip adductor problems are described as the classic hockey overuse complaint on the basis of general coaching consensus; no prevalence figure is given because none is reliably established. (9) The soreness-versus-pain triage heuristic in "Avoiding Injury While Developing" traces to no clinical guideline and is labelled inline as a rule of thumb rather than a test. (10) The external-focus-of-attention effect is treated here as **contested**: Wulf (2013) and **Chua, Jimenez-Diaz, Lewthwaite, Kim & Wulf (2021), *Psychological Bulletin* 147(6):618–645** — the meta-analysis of 73 performance studies (1,824 participants) and 40 learning studies (1,274 participants) that reported external-focus superiority at g = 0.264 for performance, 0.583 for retention and 0.584 for transfer — support it; McKay et al. (2024), also in *Psychological Bulletin* and reanalysing that same body of data, found moderate to strong publication bias across the whole literature and near-zero bias-corrected effects. (11) **The retrieval-practice section carries a limit that applies to all of it: every study cited there used verbal material — prose passages, trivia questions, word pairs — with university undergraduates. None measured a motor skill and none was conducted in a sport, so nothing in that section is evidence about on-ice practice, and it is not offered as any.** Two further gaps are worth stating. Adesope, Trevisan and Sundararajan's 2017 meta-analysis in *Review of Educational Research* is the second pooled estimate usually cited alongside Rowland's; **it is deliberately not cited here, because every route to it returned an abstract stripped of its statistics, and its figures are therefore not quoted from memory.** And Karpicke and Aue's published rebuttal to van Gog and Sweller, in the same 2015 issue of *Educational Psychology Review*, could not be obtained either — so that dispute is reported as open rather than settled in either direction. (12) **"Two shorter sessions a week beat one long one" is coaching guidance, and no study is cited here that tests it.** A search for distributed- and massed-practice research found that a motor-skill literature does exist separately from the verbal-learning work in (11), so the two are not one body of evidence — but it does not settle the advice. Almost all of it varies the rest between *repetitions*, in seconds, rather than the gap between *sessions*, in days, and its results diverge. Lee and Genovese (1989) built a discrete and a continuous version of one timing task and found that "acquisition and retention were facilitated by distributed practice on the continuous task, but by massed practice on the discrete task". Panchuk and colleagues (2013), on the Australian Football handball pass, concluded that "massed practice of a discrete sport skill may lead to better retention of learning over a two-week period". No ice hockey study was found on either side. Both papers were read as abstracts only. (13) **A group of prevalence and ranking claims in this document are coaching observation rather than measurement, and each is labelled inline where it appears**: that receiving is the more neglected half of passing and the more valuable one; that most amateur turnovers are failed receptions rather than bad passes; that a technique change is usually abandoned between weeks two and five, just before it would have paid; that puck contacts per player rise several-fold in a small-area game; that half a team practice is spent queuing, and that two players get threefold different value from the same session; and that a sudden jump in load rather than contact is the commonest way an amateur gets hurt. Crossref and OpenAlex were searched on 2 September 2026 for counts of how players divide practice repetitions between skills, for the timing of abandoned technique changes, for touches per player in small-area against full-ice practice, and for a ranking of amateur ice hockey injury causes; **nothing on point was returned by any of them.** Read that as "none found here" rather than as proof that none exists. [Shooting](../technique/shooting.md) records the same absence for how players split their repetitions between shot types, naming the databases and the date it searched.*
