...
>
> **Related:** [Puck Handling](puck_handling.md) · [Puck Support and Spacing](../hockey-iq/puck_support_and_spacing.md) · [Risk Management](../hockey-iq/risk_management.md) · [Scanning and Anticipation](../hockey-iq/scanning_and_anticipation.md) · [Breakouts](../systems/breakouts.md) · [UK and England Rules](../foundation/uk_rules.md)
...
*Rules: [NHL Official Rules 2025-2026 (PDF)](https://media.d3.nhle.com/image/private/t_document/prd/slwjuaqwmuvj5bkplixo.pdf) — Rule 49.2 (Kicking – Goals), Rule 67.2 (Handling Puck – Minor Penalty, Player, and the note to 67.2(ii) escalating a covered puck in the goal crease), Rule 67.4 (Penalty Shot), Rule 67.5 (Awarded Goal), Rule 63.6 (the puck-location test for that shot; read 29 August 2026), Rule 79.1 / 79.2 (Hand Pass), Rule 80.1 (High-sticking the Puck), Rule 83.1 (Off-side). Background on the abolition of the two-line pass: [Two-line pass — Wikipedia](https://en.wikipedia.org/wiki/Two-line_pass) · [Hand pass — Wikipedia](https://en.wikipedia.org/wiki/Hand_pass)*
