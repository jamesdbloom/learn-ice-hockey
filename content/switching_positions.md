...
| **Forward → defence** | Attack the puck, win it back | **Chasing.** Both defencemen drawn to the puck, goalmouth empty. Coaches at every level name this as one of the commonest causes of goals against — coaching consensus, not a statistic; [Defensive Zone Coverage](defensive_zone_coverage.md) owns the claim and the caveat |
...
4. **Faceoffs are learnable, and there is a number behind that claim** — a 22-point spread among NHL centres taking 500-plus draws in 2025-26, computed from the NHL's official statistics and owned by [Faceoffs](faceoffs.md).
