...
Key: You are your team's primary faceoff taker — and most draws barely matter; the ten to fifteen that do are in your own end, on special teams, in the last minute, and after an icing
...
Action: When you leave the slot for the corner, the weak-side winger collapses to cover it — call the rotation early so the slot is never empty
```
...
```facts
Priority: Ten to fifteen draws a game matter enormously — your own end, special teams, the last minute, and after an icing
...
6. Faceoffs are your defining skill — roughly 56 are taken in an average NHL game, by both teams together, computed from NHL official statistics and owned by [Faceoffs](../systems/faceoffs.md) — and most barely matter. The ten to fifteen that do are in your own end, on special teams, in the last minute, and after an icing.
