...
Rule: The IIHF carries the same minor and the same carve-outs, "except where there is no protective glass" (IIHF Rule 63.2(III)) — so it binds a British player too, and its Situation Handbook exempts only a puck shot directly into the bench, not one clearing the glass into it (Situation 63.24)
...
Action: Call for that collapse; if it doesn't come, hold the goalmouth anyway and call louder
...
Key: If you have just been moved up from forward, this is the barrier — the switch is a technical rebuild, not a set of new decisions
```
...
Position: Defensive zone — the other is in the slot, ready to block a point shot or cover the net front
...
Rule: After your own icing, under NHL and IIHF rules (81.4, 87.1) you cannot change lines and your team cannot take a time-out
Rule: USA Hockey imposes neither — nothing in Rule 624 restricts substitution, Rule 204 lets you change at any stoppage, and Rule 636(f) puts no icing condition on time-outs
Rule: USA Hockey grants the shorthanded icing exemption only from Youth 15-Only, Girls 16U, High School and Adult upward (Rule 624(b)(1))
...
**The cost lands on your pair.** After your own icing the draw is in your zone, and **under NHL and IIHF rules** you **cannot change** and your team cannot take a timeout. So the punishment for a tired clear is being kept out there tired, in the most dangerous zone on the ice, for a faceoff. When you are gassed, the glass is the answer. **⚠️ One book is softer:** IIHF Rules 81.4 and 87.1 impose both restrictions — so if you play British or European league hockey, assume the full penalty; 87.1's icing sentence is the NHL's in the same words, and 81.4's only departure is one extra substitution exception, for *"a Player with a broken skate"*. **⚠️ Do not plan a shift around that exception**, because the IIHF book states the icing substitution bar **twice** and the two statements differ: Rule 82.1 restates it for a team in violation of *"Rule 63.8 – Delaying the Game or Rule 81 – Icing"* and lists **only the other three** exceptions, without the broken skate. Which list controls has not been published: 81.4 is the icing-specific rule, but the IIHF Situation Handbook cites 81.4 and 82.1 together rather than choosing between them, and says nothing about a broken skate. The British In-House Rules amend neither rule. Tell the official your blade has gone and expect to be kept out there. **USA Hockey is the softer book: it imposes neither restriction**, because nothing in Rule 624 restricts substitution, Rule 204 lets you change at any stoppage, and Rule 636(f) puts no icing condition on time-outs. [Rules Primer](../foundation/rules_primer.md) covers this.
